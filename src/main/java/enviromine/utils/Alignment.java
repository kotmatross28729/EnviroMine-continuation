...
public enum Alignment {
    ...
    public static Alignment fromString(String string) {
        if (string.equals("TOPLEFT")) return TOPLEFT;
        if (string.equals("TOPCENTER")) return TOPCENTER;
        if (string.equals("TOPRIGHT")) return TOPRIGHT;
        if (string.equals("CENTERLEFT")) return CENTERLEFT;
        if (string.equals("CENTERCENTER")) return CENTERCENTER;
        if (string.equals("CENTERRIGHT")) return CENTERRIGHT;
        if (string.equals("BOTTOMLEFT")) return BOTTOMLEFT;
        if (string.equals("BOTTOMCENTER")) return BOTTOMCENTER;
        if (string.equals("BOTTOMRIGHT")) return BOTTOMRIGHT;
    ...
    public static Alignment calculateAlignment(int x, int y, int screenWidth, int screenHeight) {
        ...
        if (x == 1 && y == 0) return TOPCENTER;
        if (x == 2 && y == 0) return TOPRIGHT;
        if (x == 0 && y == 1) return CENTERLEFT;
        if (x == 1 && y == 1) return CENTERCENTER;
        if (x == 2 && y == 1) return CENTERRIGHT;
        if (x == 0 && y == 2) return BOTTOMLEFT;
        if (x == 1 && y == 2) return BOTTOMCENTER;
        if (x == 2 && y == 2) return BOTTOMRIGHT;
