...
public @interface CompatDanger {
    ...
    // This very rarely causes problems, with crashes like `NoClassDefFoundError` if the corresponding mod for which
    // there is compatibility in the main class is not loaded
