...
public class EM_Gui_Hud_Items extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        for (HudItem hudItem : HUDRegistry.getHudItemList()) {
            ...
            GuiButton Button = new GuiButton(
                hudItem.getDefaultID(),
                this.width / 2 + 5 - 20,
                this.height / 6 + 24 + (buttonCnt * 24) - 6,
                120,
                20,
                hudItem.getButtonLabel());

            GuiButton rotateButton = new GuiButton(
                hudItem.getDefaultID() + 200,
                this.width / 2 + 5 - 20 + 130,
                this.height / 6 + 24 + (buttonCnt * 24) - 6,
                20,
                20,
                (hudItem.rotated ? "V" : "H"));
        ...
        this.buttonList.add(
            new GuiButton(
                ...
                150,
                20,
                StatCollector.translateToLocal("options.enviromine.hud.resetDefault")));
                ...
                case 801:
                    this.mc.displayGuiScreen(
                        new GuiYesNo(
                            this,
                            StatCollector.translateToLocal("options.enviromine.hud.resetDefault"),
                            StatCollector.translateToLocal("options.enviromine.hud.resetDefault.desc"),
                            1));
                    return;
                default:
                    for (HudItem hudItem : HUDRegistry.getHudItemList()) {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(
            ...
            StatCollector.translateToLocal("options.enviromine.guiBarPos.title"),
            this.width / 2,
            15,
            16777215);
