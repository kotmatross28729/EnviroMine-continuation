...
public class ProfileMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        int createWidth = Math
            .max(mc.fontRenderer.getStringWidth(I18n.format("editor.enviromine.createNewProfile")) + 20, 100);
        this.buttonList.add(new GuiButtonExt(200, 20, this.height - 29, doneWidth, 20, I18n.format("gui.back")));
        this.buttonList.add(
            new GuiButtonExt(
                201,
                this.width - createWidth - 20,
                this.height - 29,
                createWidth,
                20,
                I18n.format("editor.enviromine.createNewProfile")));
        this.profileList = new ProfileListExtended(
            this.mc,
            this.width,
            this.height,
            32,
        ...
        if (par1GuiButton.enabled) {
            if (par1GuiButton.id == 201) {
                Minecraft.getMinecraft()
                    .displayGuiScreen(new NameProfile(this.parentGuiScreen));
    ...
    protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
        if (this.profileList.func_148179_a(p_73864_1_, p_73864_2_, p_73864_3_)) {
            ...
            mc.thePlayer
                .addChatMessage(new ChatComponentText("Loading " + EM_ConfigHandler.getProfileName() + " Profile."));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(
            ...
            I18n.format("editor.enviromine.selectProfile"),
            this.width / 2,
            15,
            16777215);
