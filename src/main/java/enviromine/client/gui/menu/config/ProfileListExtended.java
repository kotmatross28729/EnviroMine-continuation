...
public class ProfileListExtended extends GuiListExtended {
    ...
    public ProfileListExtended(Minecraft mc, int x, int y, int p_i45010_4_, int p_i45010_5_, int p_i45010_6_,
        ...
        for (File entry : profileDir) {
            ...
            if (entry.isDirectory()) {
                String profileName = entry.toString()
                    .substring(EM_ConfigHandler.profilePath.length())
                    .toUpperCase();
