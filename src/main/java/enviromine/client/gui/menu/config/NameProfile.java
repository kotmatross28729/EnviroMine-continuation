...
public class NameProfile extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
            new GuiButton(
                ...
                this.width / 2 - 100,
                this.height / 4 + 96 + 12,
                I18n.format("editor.enviromine.create", new Object[0])));
        this.buttonList.add(
            new GuiButton(
                1,
                this.width / 2 - 100,
        ...
        this.genModConfigs = new GuiCheckBox(
            2,
            this.width / 2 - 100,
            90,
            I18n.format("editor.enviromine.genModConfigs"),
            false);
        this.genBasicConfigs = new GuiCheckBox(
            3,
            this.width / 2 - 100,
            110,
            I18n.format("editor.enviromine.genBasicConfigs"),
            false);
    ...
    public void actionPerformed(GuiButton par1GuiButton) {
        ...
        if (par1GuiButton.enabled) {
            if (par1GuiButton.id == 1) {
                ...
                String newProfile = this.textFieldList.getText()
                    .trim();

                if (this.textFieldList.getText()
                    .trim()
                    .length() > 0) {
    ...
    protected void keyTyped(char p_73869_1_, int p_73869_2_) {
        ...
        ((GuiButton) this.buttonList.get(0)).enabled = this.textFieldList.getText()
            .trim()
            .length() > 0;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(
            ...
            I18n.format("editor.enviromine.nameProfile"),
            this.width / 2,
            15,
            16777215);
