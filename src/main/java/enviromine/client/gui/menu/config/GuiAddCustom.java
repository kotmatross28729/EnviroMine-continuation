    ...
    public void initGui() {
        if (!this.fail) {
            ...
            if (this.objArmor != null) {
                if (EM_ConfigMenu.ElementExist(this.objItem, ItemProperties.base)
                    && EM_ConfigMenu.ElementExist(this.objArmor, ArmorProperties.base)) {
                    this.buttonList.add(
                        new GuiButtonExt(
                            107,
                            this.width / 2 - (blockWidth / 2),
                            (this.height / 2) - 25,
                            blockWidth,
                            20,
                            editArmorI));
                ...
                } else if (!EM_ConfigMenu.ElementExist(this.objItem, ItemProperties.base)
                    && EM_ConfigMenu.ElementExist(this.objArmor, ArmorProperties.base)) {
                        this.buttonList.add(
                            new GuiButtonExt(
                                105,
                ...
                if (EM_ConfigMenu.ElementExist(this.objItem, ItemProperties.base)
                    && EM_ConfigMenu.ElementExist(this.objBlock, BlockProperties.base)) {
                    this.buttonList.add(
                        new GuiButtonExt(
                            103,
                            this.width / 2 - (blockWidth / 2),
        ...
        this.buttonList.add(
            new GuiButton(200, this.width / 2 - 100, this.height / 6 + 168, I18n.format("gui.cancel", new Object[0])));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (!this.fail) {
            this.drawCenteredString(
                ...
                I18n.format("editor.enviromine.GuiAdd.title", this.objName),
                this.width / 2,
                15,
                16777215);
        } else {
            this.drawCenteredString(
                this.fontRendererObj,
                I18n.format("editor.enviromine.GuiAdd.title.fail"),
                this.width / 2,
                15,
                16777215);
        }
