...
public class GuiAddCustom extends GuiScreen
{
	...
	public GuiAddCustom(Object obj)
	{
		...
		if(obj instanceof Item)
		{
			...
			{
				this.fail = true;
				if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger.log(Level.WARN, "Failed to Cast Item and Block for GuiAddCustom");
			}
		...
		else if(obj instanceof Block)
		{
			...
			{
				this.fail = true;
				if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger.log(Level.WARN, "Failed to Cast Block and Item for GuiAddCustom");
