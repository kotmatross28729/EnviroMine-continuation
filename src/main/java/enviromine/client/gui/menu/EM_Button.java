    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            if (strWidth + upWidth > width - 6 && strWidth + upWidth > ellipsisWidth)
                UpdateText = mc.fontRenderer.trimStringToWidth(UpdateText, width - 6 - ellipsisWidth)
                    .trim() + "...";
            ...
            if (this.draw) this.drawString(
                mc.fontRenderer,
                UpdateText,
                this.xPosition + this.width - upWidth - 3,
                this.yPosition + (this.height - 8) / 2,
                RenderAssist.getColorFromRGBA(214, 242, 36, 0));
