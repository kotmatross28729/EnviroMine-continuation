...
public class GasMaskHud {
    ...
    public static final ResourceLocation gasMaskResource = new ResourceLocation(
        "enviromine",
        "textures/misc/maskblur2.png");
    public static final ResourceLocation breathMaskResource = new ResourceLocation(
        "enviromine",
        "textures/misc/breath.png");
        ...
        if (itemstack != null && itemstack.getItem() != null) {
            if (itemstack.getItem() == ObjectHandler.gasMask) {
                ...
                if (mc.gameSettings.thirdPersonView == 0) {
                    ...
                    RenderAssist.drawScreenOverlay(
                        scaledresolution.getScaledWidth(),
                        scaledresolution.getScaledHeight(),
                        RenderAssist.getColorFromRGBA(255, 255, 255, 255));
                }
            }
        }
    ...
    public static void Renderbreath(int screenWidth, int screenHeight, Minecraft mc, ItemStack itemstack) {
        ...
        if (itemstack.hasTagCompound() && itemstack.getTagCompound()
            ...
            if (itemstack.getTagCompound()
                .getInteger(EM_Settings.GAS_MASK_FILL_TAG_KEY) <= 25 && mc.gameSettings.thirdPersonView == 0) {
