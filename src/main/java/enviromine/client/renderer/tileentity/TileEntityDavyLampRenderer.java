...
public class TileEntityDavyLampRenderer extends TileEntitySpecialRenderer {
    ...
    public TileEntityDavyLampRenderer() {
        ...
        texLit = new ResourceLocation[] {
            new ResourceLocation("enviromine", "textures/models/blocks/davy_lamp_model_lit_0.png"),
            new ResourceLocation("enviromine", "textures/models/blocks/davy_lamp_model_lit_1.png") };
        texGas = new ResourceLocation[] {
            new ResourceLocation("enviromine", "textures/models/blocks/davy_lamp_model_gas_0.png"),
            new ResourceLocation("enviromine", "textures/models/blocks/davy_lamp_model_gas_1.png") };
    }

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        int pass = (int) (tileEntity.getWorldObj()
            .getTotalWorldTime() / 2
            % 2);
        GL11.glPushMatrix();
