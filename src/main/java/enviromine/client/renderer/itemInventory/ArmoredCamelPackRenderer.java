...
public class ArmoredCamelPackRenderer implements IItemRenderer {
    ...
    public static final ResourceLocation camelpackOverlay = new ResourceLocation(
        "enviromine",
        "textures/items/camel_pack.png");
    ...
    public void renderItem(ItemRenderType type, ItemStack itemStack, Object... data) {
        ...
        if (itemStack.hasTagCompound() && itemStack.getTagCompound()
            ...
            .hasKey(EM_Settings.CAMEL_PACK_FILL_TAG_KEY)) {
                ...
                // String text =
                // Integer.toString(itemStack.getTagCompound().getInteger(EM_Settings.CAMEL_PACK_FILL_TAG_KEY));
    ...
    public void renderFillBar(ItemStack itemStack) {
        ...
        int height = 10;
        int width = 1;
        int fill = itemStack.getTagCompound()
            .getInteger(EM_Settings.CAMEL_PACK_FILL_TAG_KEY);
        int max = itemStack.getTagCompound()
        ...
        this.renderQuad(
            ...
            width + 1,
            height,
            RenderAssist.getColorFromRGBA(172, 172, 172, 255));
