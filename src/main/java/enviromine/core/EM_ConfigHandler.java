...
public class EM_ConfigHandler
{
	...
	private static void loadGlobalConfig(File file)
	{
        ...
        EM_Settings.StrongArmorMaxTemp = config.getFloat("1-6_StrongArmorMaxTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.StrongArmorMaxTemp, -65536F, 65536F, "If the armor has 12.Is Temperature Sealed = true, and body temperature < this number, body temperature will be maintained at 36.6");
		EM_Settings.StrongArmorMaxTempRise = config.getFloat("1-6-2_StrongArmorMaxTempRise", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.StrongArmorMaxTempRise, -65536F, 65536F, "If the armor has 12.Is Temperature Sealed = true, and temperature rise < this number, body temperature will be maintained at 36.6");
		EM_Settings.StrongArmorMinTemp = config.getFloat("1-6-3_StrongArmorMinTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.StrongArmorMinTemp, -65536F, 65536F, "If the armor has 12.Is Temperature Sealed = true, and body temperature > this number, body temperature will be maintained at 36.6");
		EM_Settings.StrongArmorMinTempDrop = config.getFloat("1-6-4_StrongArmorMinTempDrop", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.StrongArmorMinTempDrop, -65536F, 65536F, "If the armor has 12.Is Temperature Sealed = true, and temperature drop > this number, body temperature will be maintained at 36.6");
		
		
		EM_Settings.LightArmorMaxTemp = config.getFloat("1-7_LightArmorMaxTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.LightArmorMaxTemp, -65536F, 65536F, "If the armor has 11.Is Temperature Resistance = true, and body temperature < this number, body temperature will be maintained at 36.6");
		EM_Settings.LightArmorMaxTempRise = config.getFloat("1-7-2_LightArmorMaxTempRise", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.LightArmorMaxTempRise, -65536F, 65536F, "If the armor has 11.Is Temperature Resistance = true, and temperature rise < this number, body temperature will be maintained at 36.6");
		EM_Settings.LightArmorMinTemp = config.getFloat("1-7-3_LightArmorMinTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.LightArmorMinTemp, -65536F, 65536F, "If the armor has 11.Is Temperature Resistance = true, and body temperature > this number, body temperature will be maintained at 36.6");
		EM_Settings.LightArmorMinTempDrop = config.getFloat("1-7-4_LightArmorMinTempDrop", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.LightArmorMinTempDrop, -65536F, 65536F, "If the armor has 11.Is Temperature Resistance = true, and temperature drop > this number, body temperature will be maintained at 36.6");
        ...
        EM_Settings.RTGFurnaceHeatConstant = config.getFloat("57_RTGFurnaceHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.RTGFurnaceHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        ...
        EM_Settings.DieselGenHeatConstant = config.getFloat("59_DieselGenHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DieselGenHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        EM_Settings.ICEHeatConstant = config.getFloat("60_ICEHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.ICEHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        EM_Settings.CyclotronHeatConstant = config.getFloat("61_CyclotronHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CyclotronHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        ...
        EM_Settings.ArcFurnaceHeatConstant = config.getFloat("64_ArcFurnaceHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.ArcFurnaceHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        EM_Settings.FlareStackHeatConstant = config.getFloat("65_FlareStackHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FlareStackHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        ...
        EM_Settings.TurbofanHeatConstant = config.getFloat("67-1_TurbofanHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TurbofanHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees)");
        EM_Settings.TurbofanAfterburnerHeatConstant = config.getFloat("67-2_TurbofanAfterburnerHeatConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TurbofanAfterburnerHeatConstant, -65536, 65536,  "The ambient temperature from this machine is a constant you can specify (in Celsius degrees). Turbofan specifics - temperature when using the \"Afterburner\" upgrade");
        ...
        EM_Settings.SaltyWaterTemperatureInfluence = config.getFloat("73_SaltyWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SaltyWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.DirtyWaterTemperatureInfluence = config.getFloat("74_DirtyWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.CleanWaterTemperatureInfluence = config.getFloat("75_CleanWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.CleanWarmWaterTemperatureInfluence = config.getFloat("76_CleanWarmWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWarmWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.DirtyWarmWaterTemperatureInfluence = config.getFloat("77_DirtyWarmWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWarmWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.HotWarmWaterTemperatureInfluence = config.getFloat("78_HotWarmWaterTemperatureInfluence",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HotWarmWaterTemperatureInfluence, -65536, 65536,  "When the player drinks this type of water, their temperature changes by this value");

        EM_Settings.WaterReducesTemperatureStartingValue = config.getFloat("79_WaterReducesTemperatureStartingValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.WaterReducesTemperatureStartingValue, -65536, 65536,  "The temperature will change when the player drinks salt/clean/dirty water and his body temperature is >= this value");
        EM_Settings.ColdFrostyWaterReducesTemperatureStartingValue = config.getFloat("80_ColdFrostyWaterReducesTemperatureStartingValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.ColdFrostyWaterReducesTemperatureStartingValue, -65536, 65536,  "The temperature will change when the player drinks cold/frosty water and his body temperature is >= this value");
        EM_Settings.WarmHotWaterReducesTemperatureStartingValue = config.getFloat("81_WarmHotWaterReducesTemperatureStartingValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.WarmHotWaterReducesTemperatureStartingValue, -65536, 65536,  "The temperature will change when the player drinks warm/hot water and his body temperature is >= this value");

        EM_Settings.FrostyWaterHydrate          = config.getFloat("82_FrostyWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FrostyWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydrate       = config.getFloat("83_DirtyColdWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyColdWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydrate       = config.getFloat("84_CleanColdWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanColdWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydrate           = config.getFloat("85_SaltyWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SaltyWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydrate           = config.getFloat("86_DirtyWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        //in item props
        EM_Settings.CleanWaterHydrate           = config.getFloat("87_CleanWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydrate       = config.getFloat("88_CleanWarmWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWarmWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydrate       = config.getFloat("89_DirtyWarmWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWarmWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.HotWaterHydrate             = config.getFloat("90_HotWaterHydrate",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HotWaterHydrate, -65536, 65536,  "When a player drinks this type of water, their hydration will increase by that amount");

        EM_Settings.FrostyWaterHydratePlastic         = config.getFloat("91_FrostyWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FrostyWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydratePlastic      = config.getFloat("92_DirtyColdWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyColdWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydratePlastic      = config.getFloat("93_CleanColdWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanColdWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydratePlastic          = config.getFloat("94_SaltyWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SaltyWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydratePlastic          = config.getFloat("95_DirtyWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanWaterHydratePlastic          = config.getFloat("96_CleanWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydratePlastic      = config.getFloat("97_CleanWarmWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWarmWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydratePlastic      = config.getFloat("98_DirtyWarmWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWarmWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.HotWaterHydratePlastic        = config.getFloat("99_HotWaterHydratePlastic",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HotWaterHydratePlastic, -65536, 65536,  "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");

        EM_Settings.FrostyWaterHydrateWorld         = config.getFloat("a-100_FrostyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FrostyWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydrateWorld      = config.getFloat("a-101_DirtyColdWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyColdWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydrateWorld      = config.getFloat("a-102_CleanColdWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanColdWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydrateWorld          = config.getFloat("a-103_SaltyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SaltyWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydrateWorld          = config.getFloat("a-104_DirtyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWaterHydrateWorld          = config.getFloat("a-105_CleanWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydrateWorld      = config.getFloat("a-106_CleanWarmWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWarmWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydrateWorld      = config.getFloat("a-107_DirtyWarmWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWarmWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.HotWaterHydrateWorld        = config.getFloat("a-108_HotWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HotWaterHydrateWorld, -65536, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");

        EM_Settings.SanityDropHealth                   = config.getFloat("a-109_SanityDropHealth",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropHealth, 0, 65536,  "When the player's health <= this value, sanity will begin to decrease");
        EM_Settings.SanityDropTemperatureHigh          = config.getFloat("a-110_SanityDropTemperatureHigh",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropTemperatureHigh, -65536, 65536,  "When player's body temperature >= this value, sanity will begin to decrease");
        EM_Settings.SanityDropTemperatureLow           = config.getFloat("a-111_SanityDropTemperatureLow",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropTemperatureLow, -65536, 65536,  "When player's body temperature <= this value, sanity will begin to decrease");

        EM_Settings.NTMSpaceAirQualityDecrease                   = config.getFloat("a-112_NTMSpaceAirQualityDecrease",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NTMSpaceAirQualityDecrease, -65536, 65536,  "If the player cannot breathe (not a suitable atmosphere) the air quality will begin to decrease by this value");
        EM_Settings.NTMSpaceAirVentAirQualityIncrease            = config.getFloat("a-113_NTMSpaceAirVentAirQualityIncrease",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NTMSpaceAirVentAirQualityIncrease, -65536, 65536,  "Air vent will replenish this amount of air quality when running");

        EM_Settings.RealTemperatureConstant                     = config.getFloat("a-114_RealTemperatureConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.RealTemperatureConstant, -65536, 65536,  "A constant used to calculate the player's body temperature. Ambient temperature + this constant = player's expected body temperature");

        EM_Settings.TimeBelow10AirAndTemperatureConstantAir                      = config.getFloat("a-115_TimeBelow10AirAndTemperatureConstantAir",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10AirAndTemperatureConstantAir, -65536, 65536,  "When the air temperature <= this value and the player's body temperature <= TimeBelow10AirAndTemperatureConstantBodyTemperature, a countdown will begin, at the end of which the player will be permanently frostbite");
        EM_Settings.TimeBelow10AirAndTemperatureConstantBodyTemperature          = config.getFloat("a-116_TimeBelow10AirAndTemperatureConstantBodyTemperature",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10AirAndTemperatureConstantBodyTemperature, -65536, 65536,  "When the player's body temperature <= this value and the air temperature <= TimeBelow10AirAndTemperatureConstantAir, a countdown will begin, at the end of which the player will be permanently frostbite");
        EM_Settings.TimeBelow10BodyTemperatureConstant                           = config.getFloat("a-117_TimeBelow10BodyTemperatureConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10BodyTemperatureConstant, -65536, 65536,  "When the player's body temperature <= this value, a countdown will begin, at the end of which the player will be permanently frostbite");

        EM_Settings.BodyTemperatureHeatStartValue            = config.getFloat("a-118_BodyTemperatureHeatStartValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatStartValue, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (1 lvl)");
        EM_Settings.BodyTemperatureHeatInstantDeath            = config.getFloat("a-119_BodyTemperatureHeatInstantDeath",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatInstantDeath, -65536, 65536,  "If the player's body temperature is >= this value, they will die instantly");

        EM_Settings.BodyTemperatureHeatstroke6            = config.getFloat("a-120_BodyTemperatureHeatstroke6",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke6, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (6 lvl)");
        EM_Settings.BodyTemperatureHeatstroke5            = config.getFloat("a-121_BodyTemperatureHeatstroke5",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke5, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (5 lvl)");
        EM_Settings.BodyTemperatureHeatstroke4            = config.getFloat("a-122_BodyTemperatureHeatstroke4",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke4, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (4 lvl)");
        EM_Settings.BodyTemperatureHeatstroke3            = config.getFloat("a-123_BodyTemperatureHeatstroke3",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke3, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (3 lvl)");
        EM_Settings.BodyTemperatureHeatstroke2            = config.getFloat("a-124_BodyTemperatureHeatstroke2",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke2, -65536, 65536,  "From this temperature value, the player will receive the effect of heatstroke (2 lvl)");

        EM_Settings.BodyTemperatureCatchFireMin                 = config.getFloat("a-125_BodyTemperatureCatchFireMin",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureCatchFireMin, -65536, 65536,  "If the player's body temperature is >= this value, and there is lava nearby, the player will catch fire");
        EM_Settings.BodyTemperatureCatchFireMax                 = config.getFloat("a-126_BodyTemperatureCatchFireMax",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureCatchFireMax, -65536, 65536,  "If the player's body temperature is >= this value, the player will catch fire");
        ...
        EM_Settings.BodyTemperatureColdStartValue                   = config.getFloat("a-128_BodyTemperatureColdStartValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureColdStartValue, -65536, 65536,  "From this temperature value, the player will receive the effect of hypothermia (1 lvl)");
        EM_Settings.BodyTemperatureColdStartValueVampire            = config.getFloat("a-129_BodyTemperatureColdStartValueVampire",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureColdStartValueVampire, -65536, 65536,  "From this temperature value, (if the player is a vampire) the player will receive the effect of hypothermia (1 lvl)");
        EM_Settings.BodyTemperatureHypothermia3                     = config.getFloat("a-130_BodyTemperatureHypothermia3",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia3, -65536, 65536,  "From this temperature value, the player will receive the effect of hypothermia (3 lvl)");
        EM_Settings.BodyTemperatureHypothermia2                     = config.getFloat("a-131_BodyTemperatureHypothermia2",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia2, -65536, 65536,  "From this temperature value, the player will receive the effect of hypothermia (2 lvl)");
        EM_Settings.BodyTemperatureHypothermia2Vampire              = config.getFloat("a-132_BodyTemperatureHypothermia2Vampire",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia2Vampire, -65536, 65536,  "From this temperature value, (if the player is a vampire) the player will receive the effect of hypothermia (2 lvl)");
        ...
        EM_Settings.SanityStage0UpperBound              = config.getFloat("a-136_SanityStage0UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage0UpperBound, -65536, 65536,  "If current sanity <= this value, and > SanityStage0LowerBound, the player will receive the effect of insanity (1 lvl)");
        EM_Settings.SanityStage0LowerBound              = config.getFloat("a-137_SanityStage0LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage0LowerBound, -65536, 65536,  "See SanityStage0UpperBound");
        EM_Settings.SanityStage1UpperBound              = config.getFloat("a-138_SanityStage1UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage1UpperBound, -65536, 65536,  "If current sanity <= this value, and > SanityStage1LowerBound, the player will receive the effect of insanity (2 lvl)");
        EM_Settings.SanityStage1LowerBound              = config.getFloat("a-139_SanityStage1LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage1LowerBound, -65536, 65536,  "See SanityStage1UpperBound");
        EM_Settings.SanityStage2UpperBound              = config.getFloat("a-140_SanityStage2UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage2UpperBound, -65536, 65536,  "If current sanity <= this value, and > SanityStage2LowerBound, the player will receive the effect of insanity (3 lvl)");
        EM_Settings.SanityStage2LowerBound              = config.getFloat("a-141_SanityStage2LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage2LowerBound, -65536, 65536,  "See SanityStage2UpperBound");
        EM_Settings.SanityStage3UpperBound              = config.getFloat("a-142_SanityStage3UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage3UpperBound, -65536, 65536,  "If current sanity <= this value, and > SanityStage3LowerBound, the player will receive the effect of insanity (4 lvl), and the countdown to a heart attack will begin");
        EM_Settings.SanityStage3LowerBound              = config.getFloat("a-143_SanityStage3LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage3LowerBound, -65536, 65536,  "See SanityStage2UpperBound");
        ...
        EM_Settings.SanityRateDecreaseDark          = config.getFloat("a-145_SanityRateDecreaseDark",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityRateDecreaseDark, -65536, 65536,  "Sanity Rate will decrease by this number if the player is in the dark");
        EM_Settings.SanityBoostFlowers              = config.getFloat("a-146_SanityBoostFlowers",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityBoostFlowers, -65536, 65536,  "Sanity Boost, which is given by flowers in the inventory");

        EM_Settings.AirQualityIncreaseLight                 = config.getFloat("a-147_AirQualityIncreaseLight",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.AirQualityIncreaseLight, -65536, 65536,  "Air quality will increase by this value if the player is in a lit area");
        EM_Settings.SanityRateIncreaseLight                 = config.getFloat("a-148_SanityRateIncreaseLight",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityRateIncreaseLight, -65536, 65536,  "Sanity Rate will increase by this value if the player is in a lit area");
        EM_Settings.SanityRateDecreaseLight                 = config.getFloat("a-149_SanityRateDecreaseLight",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityRateDecreaseLight, -65536, 65536,  "Sanity Rate will decrease by this value if the player is NOT in a lit area AND current Sanity Rate < 0");
        EM_Settings.SurfaceYPositionMultiplier              = config.getFloat("a-150_SurfaceYPositionMultiplier",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SurfaceYPositionMultiplier, -65536, 65536,  "The surface is defined as: sea level in dimension * this number = Y surface. For overworld it is 64*0.75=48");
        EM_Settings.AirQualityIncreaseSurface               = config.getFloat("a-151_AirQualityIncreaseSurface",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.AirQualityIncreaseSurface, -65536, 65536,  "Air quality will increase by this value if the player is on the surface");

        EM_Settings.MaxHighAltitudeTemp                  = config.getFloat("a-152_MaxHighAltitudeTemp",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.MaxHighAltitudeTemp, -65536, 65536,  "Temperature that will be at maximum altitude");
        EM_Settings.MinLowAltitudeTemp                   = config.getFloat("a-153_MinLowAltitudeTemp",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.MinLowAltitudeTemp, -65536, 65536,  "Temperature that will be at minimum altitude");
        ...
        EM_Settings.SkyYPositionLowerBound               = config.getFloat("a-155_SkyYPositionLowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SkyYPositionLowerBound, -65536, 65536,  "Y position from which temperature reduction begins");
        ...
        EM_Settings.SkyYPositionUpperBound               = config.getFloat("a-157_SkyYPositionUpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SkyYPositionUpperBound, -65536, 65536,  "Maximum altitude, at which the temperature will be equal to MaxHighAltitudeTemp (if the biome temperature is not lower)");
        EM_Settings.NTMSpaceAirVentTemperatureConstant               = config.getFloat("a-158_NTMSpaceAirVentTemperatureConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NTMSpaceAirVentTemperatureConstant, -65536, 65536,  "Temperature created in the air vent's air pocket ");
        EM_Settings.AvgEntityTempDivider               = config.getFloat("a-159_AvgEntityTempDivider",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.AvgEntityTempDivider, -65536, 65536,  "Divider for the ambient temperature of nearby mobs");
        ...
        EM_Settings.AmbientTemperatureblockAndItemTempInfluencebiomeTemperatureForRiseSpeedConstant = config.getFloat("a-161_AmbientTempblockItemTempInfbiomeTemperatureForRiseSpeedConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.AmbientTemperatureblockAndItemTempInfluencebiomeTemperatureForRiseSpeedConstant, -65536, 65536,  "If influence of blocks/items > biomeTemperature + this value, then riseSpeed = AmbientTemperatureblockAndItemTempInfluenceRiseSpeedConstant");
        EM_Settings.AmbientTemperatureblockAndItemTempInfluenceRiseSpeedConstant = config.getFloat("a-162_AmbientTempblockItemTempInfRiseSpeedConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.AmbientTemperatureblockAndItemTempInfluenceRiseSpeedConstant, -65536, 65536,  "See AmbientTemperatureblockAndItemTempInfluencebiomeTemperatureForRiseSpeedConstant");

        EM_Settings.HungerEffectDehydrateBonus               = config.getFloat("a-163_HungerEffectDehydrateBonus",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HungerEffectDehydrateBonus, -65536, 65536,  "Bonus to dehydration if the player is under hunger effect");
        EM_Settings.NearLavaMinRiseSpeed                 = config.getFloat("a-164_NearLavaMinRiseSpeed",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NearLavaMinRiseSpeed, -65536, 65536,  "Minimum riseSpeed if the player is near to lava");
        EM_Settings.NearLavaDehydrateBonus               = config.getFloat("a-165_NearLavaDehydrateBonus",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NearLavaDehydrateBonus, -65536, 65536,  "Bonus to dehydration if the player is near to lava");
        EM_Settings.NoBiomeRainfallDayDehydrateBonus               = config.getFloat("a-166_NoBiomeRainfallDayDehydrateBonus",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NoBiomeRainfallDayDehydrateBonus, -65536, 65536,  "Bonus to dehydration if BiomeRainfall = 0 and it is daytime");
