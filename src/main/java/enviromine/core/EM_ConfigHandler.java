...
public class EM_ConfigHandler
{
	...
	private static void loadGlobalConfig(File file)
	{
        ...
        EM_Settings.LightArmorMinTemp = config.getFloat("1-7-2_LightArmorMinTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, 35.5F, -65536F, 65536F, "If the armor has 11.Is Temperature Resistance = true, or the armor is HEV/Environment Suit from hbm's ntm, then the body temperature will be maintained at 36.6, if at the moment the player's body temperature is not less than n");
        EM_Settings.LavaBlockAmbientTemperature = config.getFloat("1-8_LavaBlockAmbientTemperature", CATEGORY_KOTMATROSS_FORK_CHANGES, 200F, -65536F, 65536F, "Ambient Temperature will be equal to this number if the player is in lava (if the armor has 12.Is Temperature Sealed = true, then no)");
        EM_Settings.BurningambientTemperature = config.getFloat("1-9_BurningambientTemperature", CATEGORY_KOTMATROSS_FORK_CHANGES, 75F, -65536F, 65536F, "Ambient Temperature will be equal to this number if the player is on fire (or in lava if11.Is Temperature Resistance = true, if the armor has 11.Is Temperature Resistance = true, then no)");
        EM_Settings.RiseSpeedMin = config.getFloat("10_RiseSpeedMin", CATEGORY_KOTMATROSS_FORK_CHANGES, 0.1F, -65536F, 65536F, "Minimum RiseSpeed if player is on fire");
        EM_Settings.RiseSpeedLava = config.getFloat("11_RiseSpeedLava", CATEGORY_KOTMATROSS_FORK_CHANGES, 1F, -65536F, 65536F, "RiseSpeed if player in lava");
        EM_Settings.RiseSpeedLavaDecr = config.getFloat("12_RiseSpeedLavaDecr", CATEGORY_KOTMATROSS_FORK_CHANGES, 0.3F, -65536F, 65536F, "RiseSpeed if player in lava and wearing hev/env suit or armor has 11.Is Temperature Resistance = true");
        EM_Settings.SprintambientTemperature = config.getFloat("13_SprintAmbientTemperature", CATEGORY_KOTMATROSS_FORK_CHANGES, 2F, -65536F, 65536F, "The player's temperature will increase by this number when he runs");
        EM_Settings.SweatTemperature = config.getFloat("13-2_SweatTemperature", CATEGORY_KOTMATROSS_FORK_CHANGES, 38F, -65536F, 65536F, "The player will begin to sweat starting at this temperature");

        EM_Settings.SweatDehydrate = config.getFloat("13-3_SweatDehydrate", CATEGORY_KOTMATROSS_FORK_CHANGES, 0.1F, -65536F, 65536F, "When a player sweats, he will lose n% of water per second");
        EM_Settings.SweatHydration = config.getFloat("13-4_SweatHydration", CATEGORY_KOTMATROSS_FORK_CHANGES, 75F, -65536F, 65536F, "The player needs n (n or more)% of water to decrease temperature");
        EM_Settings.SweatBodyTemp = config.getFloat("13-5_SweatBodyTemp", CATEGORY_KOTMATROSS_FORK_CHANGES, 0.01F, -65536F, 65536F, "If the player has enough %water (see SweatHydration), then the body temperature will decrease by n every second");

        EM_Settings.DeathFromHeartAttack = config.getBoolean("14_Death From Heart Attack", CATEGORY_KOTMATROSS_FORK_CHANGES, true, "Should a player die from a heart attack if sanity < 5?");
        ...
        EM_Settings.hardcoregases = config.getBoolean("16_Hardcore gases", CATEGORY_KOTMATROSS_FORK_CHANGES, false, "If true, then all gases will be invisible");

        EM_Settings.HbmGasMaskBreakMultiplier = config.getInt("17_Hbm Gas Mask filter break multiplier", CATEGORY_KOTMATROSS_FORK_CHANGES, 10, 0, 65536,  "Multiplier for breaking a hbm gas mask filter");
        EM_Settings.HbmGasMaskBreakChanceNumber = config.getInt("18_Hbm Gas Mask filter break chance number", CATEGORY_KOTMATROSS_FORK_CHANGES, 15, 0, 100,  "The number on which the chance of reducing the durability of the hbm filter depends. The lower the number, the greater the chance that the filter durability will decrease");
        EM_Settings.EnviromineGasMaskBreakMultiplier = config.getInt("19_Gas Masks break multiplier", CATEGORY_KOTMATROSS_FORK_CHANGES, 10, 0, 65536,  "A number that is subtracted from the current enviromine mask filter durability if the player is in a gas block, that is suffocating");

        EM_Settings.SulfurDioxideGasDebugLogger = config.getBoolean("20_SulfurDioxideGasDebugLogger", CATEGORY_KOTMATROSS_FORK_CHANGES, false, "Don't use unless you are a developer");
        EM_Settings.CarbonMonoxideGasDebugLogger = config.getBoolean("21_CarbonMonoxideGasDebugLogger", CATEGORY_KOTMATROSS_FORK_CHANGES, false, "Don't use unless you are a developer");
        EM_Settings.HydrogenSulfideGasDebugLogger = config.getBoolean("22_HydrogenSulfideGasDebugLogger", CATEGORY_KOTMATROSS_FORK_CHANGES, false, "Don't use unless you are a developer");

        EM_Settings.SulfurDioxidePoisoningAmplifier = config.getInt("23_Sulfur Dioxide Poisoning Amplifier",CATEGORY_KOTMATROSS_FORK_CHANGES, 5, 1, 65536,  "How dense the Sulfur Dioxide gas should  be, in order for it to have the opportunity to poison you?");
        EM_Settings.SulfurDioxideSeverePoisoningAmplifier = config.getInt("24_Sulfur Dioxide Severe Poisoning Amplifier",CATEGORY_KOTMATROSS_FORK_CHANGES, 10, 1, 65536,  "How dense the Sulfur Dioxide gas should  be, in order for it to have the opportunity to severe poison you?");
        EM_Settings.SulfurDioxidePoisoningTime = config.getInt("25_Sulfur Dioxide Poisoning Time",CATEGORY_KOTMATROSS_FORK_CHANGES, 200, 1, 65536,  "How long does Sulfur Dioxide poisoning last?");
        EM_Settings.SulfurDioxideSeverePoisoningTime = config.getInt("26_Sulfur Dioxide Severe Poisoning Time",CATEGORY_KOTMATROSS_FORK_CHANGES, 600, 1, 65536,  "How long does severe Sulfur Dioxide poisoning last?");
        EM_Settings.SulfurDioxidePoisoningLevel = config.getInt("27_Sulfur Dioxide Poisoning Level",CATEGORY_KOTMATROSS_FORK_CHANGES, 0, 0, 65536,  "What level of poisoning applies when player is Sulfur Dioxide poisoned?");
        EM_Settings.SulfurDioxideSeverePoisoningLevel = config.getInt("28_Sulfur Dioxide Severe Poisoning Level",CATEGORY_KOTMATROSS_FORK_CHANGES, 1, 0, 65536,  "What level of poisoning applies when player is severe Sulfur Dioxide poisoned?");
        EM_Settings.SulfurDioxidePoisoningChance = config.getInt("29_Chance of Sulfur Dioxide Poisoning",CATEGORY_KOTMATROSS_FORK_CHANGES, 5, 1, 65536,  "What is the chance of Sulfur Dioxide poisoning if the player has no protection?");

        EM_Settings.CarbonMonoxidePoisoningAmplifier = config.getInt("30_Carbon Monoxide Poisoning Amplifier",CATEGORY_KOTMATROSS_FORK_CHANGES, 5, 1, 65536,  "How dense the Carbon Monoxide gas should  be, in order for it to have the opportunity to poison you?");
        EM_Settings.CarbonMonoxidePoisoningTime = config.getInt("31_Carbon Monoxide Poisoning Time",CATEGORY_KOTMATROSS_FORK_CHANGES, 200, 1, 65536,  "How long does Carbon Monoxide poisoning last?");
        EM_Settings.CarbonMonoxidePoisoningLevel = config.getInt("32_Carbon Monoxide Poisoning Level",CATEGORY_KOTMATROSS_FORK_CHANGES, 0, 0, 65536,  "What level of poisoning applies when player is Carbon Monoxide poisoned?");
        EM_Settings.CarbonMonoxidePoisoningChance = config.getInt("33_Chance of Carbon Monoxide Poisoning",CATEGORY_KOTMATROSS_FORK_CHANGES, 5, 1, 65536,  "What is the chance of Carbon Monoxide poisoning if the player has no protection?");

        EM_Settings.HydrogenSulfidePoisoningAmplifier = config.getInt("34_Hydrogen Sulfide Poisoning Amplifier",CATEGORY_KOTMATROSS_FORK_CHANGES, 5, 1, 65536,  "How dense the Hydrogen Sulfide gas should  be, in order for it to have the opportunity to poison you?");
        EM_Settings.HydrogenSulfideSeverePoisoningAmplifier = config.getInt("35_Hydrogen Sulfide Severe Poisoning Amplifier",CATEGORY_KOTMATROSS_FORK_CHANGES, 10, 1, 65536,  "How dense the Hydrogen Sulfide gas should  be, in order for it to have the opportunity to severe poison you?");
        EM_Settings.HydrogenSulfidePoisoningTime = config.getInt("36_Hydrogen Sulfide Poisoning Time",CATEGORY_KOTMATROSS_FORK_CHANGES, 200, 1, 65536,  "How long does Hydrogen Sulfide poisoning last?");
        EM_Settings.HydrogenSulfideSeverePoisoningTime = config.getInt("37_Hydrogen Sulfide Severe Poisoning Time",CATEGORY_KOTMATROSS_FORK_CHANGES, 600, 1, 65536,  "How long does severe Hydrogen Sulfide poisoning last?");
        EM_Settings.HydrogenSulfidePoisoningLevel = config.getInt("38_Hydrogen Sulfide Poisoning Level",CATEGORY_KOTMATROSS_FORK_CHANGES, 0, 0, 65536,  "What level of poisoning applies when player is Hydrogen Sulfide poisoned?");
