...
public class EM_ConfigHandler {
    ...
    public static final String CATEGORY_GASES = "Gases";
    public static final String CATEGORY_SPEED_MULTIPLIERS = "Speed Multipliers";
    public static final String CATEGORY_EARTHQUAKES = "Earthquakes";
    public static final String CATEGORY_EASTER_EGGS = "Easter Eggs";
    ...
    public static final String CATEGORY_KOTMATROSS_FORK_CHANGES = "Kotmatross Fork Changes: General";
    public static final String CATEGORY_KOTMATROSS_FORK_CHANGES_WATER = "Kotmatross Fork Changes: Water";
    public static final String CATEGORY_KOTMATROSS_FORK_CHANGES_GASES = "Kotmatross Fork Changes: Gases";
    public static final String CATEGORY_KOTMATROSS_FORK_CHANGES_NTM = "Kotmatross Fork Changes: Hbm's NTM Compat";
    ...
    public static int initConfig() {
        ...
        return EM_Settings.armorProperties.size() + EM_Settings.blockProperties.size()
