...
public class EM_ConfigHandler
{
	...
	private static void loadGlobalConfig(File file)
	{
        ...
        EM_Settings.BurnerPressHeatDivisor = config.getFloat("42-1_BurnerPressHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BurnerPressHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.FireboxHeatDivisor = config.getFloat("43_Firebox Heat Divisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FireboxHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        EM_Settings.HeaterOvenHeatDivisor = config.getFloat("44_Heater Oven Heat Divisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HeaterOvenHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        EM_Settings.FluidBurnerHeatDivisor = config.getFloat("45_FluidBurnerHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FluidBurnerHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");

        EM_Settings.HeaterElectricHeatDivisor = config.getFloat("46-1_HeaterElectricHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HeaterElectricHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.IronFurnaceHeatDivisor = config.getFloat("47-1_IronFurnaceHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.IronFurnaceHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.SteelFurnaceHeatDivisor = config.getFloat("48_SteelFurnaceHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SteelFurnaceHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        EM_Settings.CombinationOvenHeatDivisor = config.getFloat("49_CombinationOvenHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CombinationOvenHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");

        EM_Settings.CrucibleHeatDivisor = config.getFloat("50_CrucibleHeatDivisor", CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CrucibleHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.FurnaceBrickHeatDivisor = config.getFloat("53-1_FurnaceBrickHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FurnaceBrickHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.DiFurnaceHeatDivisor = config.getFloat("54_DiFurnaceHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DiFurnaceHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        EM_Settings.DiFurnaceRTGHeatDivisor = config.getFloat("55_DiFurnaceRTGHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DiFurnaceRTGHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        EM_Settings.NukeFurnaceHeatDivisor = config.getFloat("56_NukeFurnaceHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NukeFurnaceHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.WoodBurningGenHeatDivisor = config.getFloat("58_WoodBurningGenHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.WoodBurningGenHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
        ...
        EM_Settings.RBMKRodHeatDivisor = config.getFloat("63_RBMKRodHeatDivisor",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.RBMKRodHeatDivisor, 1, 65536,  "Divider value for temperature. The temperature itself depends on the specifics of the machine");
