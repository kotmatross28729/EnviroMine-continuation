...
public class EM_ConfigHandler
{
	...
	private static void loadGlobalConfig(File file)
	{
        ...
        EM_Settings.FrostyWaterHydrateWorld         = config.getFloat("100_FrostyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.FrostyWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydrateWorld      = config.getFloat("101_DirtyColdWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyColdWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydrateWorld      = config.getFloat("102_CleanColdWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanColdWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydrateWorld          = config.getFloat("103_SaltyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SaltyWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydrateWorld          = config.getFloat("104_DirtyWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWaterHydrateWorld          = config.getFloat("105_CleanWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydrateWorld      = config.getFloat("106_CleanWarmWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.CleanWarmWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydrateWorld      = config.getFloat("107_DirtyWarmWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.DirtyWarmWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.HotWaterHydrateWorld        = config.getFloat("108_HotWaterHydrateWorld",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.HotWaterHydrateWorld, 1, 65536,  "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");

        EM_Settings.SanityDropHealth                   = config.getFloat("109_SanityDropHealth",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropHealth, 1, 65536,  "When the player's health <= this value, sanity will begin to decrease");
        EM_Settings.SanityDropTemperatureHigh          = config.getFloat("110_SanityDropTemperatureHigh",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropTemperatureHigh, 1, 65536,  "When player's body temperature >= this value, sanity will begin to decrease");
        EM_Settings.SanityDropTemperatureLow           = config.getFloat("111_SanityDropTemperatureLow",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityDropTemperatureLow, 1, 65536,  "When player's body temperature <= this value, sanity will begin to decrease");

        EM_Settings.NTMSpaceAirQualityDecrease                   = config.getFloat("112_NTMSpaceAirQualityDecrease",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NTMSpaceAirQualityDecrease, 1, 65536,  "If the player cannot breathe (not a suitable atmosphere) the air quality will begin to decrease by this value");
        EM_Settings.NTMSpaceAirVentAirQualityIncrease            = config.getFloat("113_NTMSpaceAirVentAirQualityIncrease",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.NTMSpaceAirVentAirQualityIncrease, 1, 65536,  "Air vent will replenish this amount of air quality when running");

        EM_Settings.RealTemperatureConstant                     = config.getFloat("114_RealTemperatureConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.RealTemperatureConstant, 1, 65536,  "A constant used to calculate the player's body temperature. Ambient temperature + this constant = player's expected body temperature");

        EM_Settings.TimeBelow10AirAndTemperatureConstantAir                      = config.getFloat("115_TimeBelow10AirAndTemperatureConstantAir",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10AirAndTemperatureConstantAir, 1, 65536,  "When the air temperature <= this value and the player's body temperature <= TimeBelow10AirAndTemperatureConstantBodyTemperature, a countdown will begin, at the end of which the player will be permanently frostbite");
        EM_Settings.TimeBelow10AirAndTemperatureConstantBodyTemperature          = config.getFloat("116_TimeBelow10AirAndTemperatureConstantBodyTemperature",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10AirAndTemperatureConstantBodyTemperature, 1, 65536,  "When the player's body temperature <= this value and the air temperature <= TimeBelow10AirAndTemperatureConstantAir, a countdown will begin, at the end of which the player will be permanently frostbite");
        EM_Settings.TimeBelow10BodyTemperatureConstant                           = config.getFloat("117_TimeBelow10BodyTemperatureConstant",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10BodyTemperatureConstant, 1, 65536,  "When the player's body temperature <= this value, a countdown will begin, at the end of which the player will be permanently frostbite");

        EM_Settings.BodyTemperatureHeatStartValue            = config.getFloat("118_BodyTemperatureHeatStartValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatStartValue, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (1 lvl)");
        EM_Settings.BodyTemperatureHeatInstantDeath            = config.getFloat("119_BodyTemperatureHeatInstantDeath",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatInstantDeath, 1, 65536,  "If the player's body temperature is >= this value, they will die instantly");

        EM_Settings.BodyTemperatureHeatstroke6            = config.getFloat("120_BodyTemperatureHeatstroke6",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke6, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (6 lvl)");
        EM_Settings.BodyTemperatureHeatstroke5            = config.getFloat("121_BodyTemperatureHeatstroke5",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke5, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (5 lvl)");
        EM_Settings.BodyTemperatureHeatstroke4            = config.getFloat("122_BodyTemperatureHeatstroke4",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke4, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (4 lvl)");
        EM_Settings.BodyTemperatureHeatstroke3            = config.getFloat("123_BodyTemperatureHeatstroke3",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke3, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (3 lvl)");
        EM_Settings.BodyTemperatureHeatstroke2            = config.getFloat("124_BodyTemperatureHeatstroke2",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHeatstroke2, 1, 65536,  "From this temperature value, the player will receive the effect of heatstroke (2 lvl)");

        EM_Settings.BodyTemperatureCatchFireMin                 = config.getFloat("125_BodyTemperatureCatchFireMin",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureCatchFireMin, 1, 65536,  "If the player's body temperature is >= this value, and there is lava nearby, the player will catch fire");
        EM_Settings.BodyTemperatureCatchFireMax                 = config.getFloat("126_BodyTemperatureCatchFireMax",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureCatchFireMax, 1, 65536,  "If the player's body temperature is >= this value, the player will catch fire");
        EM_Settings.BodyTemperatureCatchFireDuration            = config.getFloat("127_BodyTemperatureCatchFireDuration",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureCatchFireDuration, 1, 65536,  "When the player is on fire (body temperature), the duration of the effect will be this value in seconds");


        EM_Settings.BodyTemperatureColdStartValue                   = config.getFloat("128_BodyTemperatureColdStartValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureColdStartValue, 1, 65536,  "From this temperature value, the player will receive the effect of hypothermia (1 lvl)");
        EM_Settings.BodyTemperatureColdStartValueVampire            = config.getFloat("129_BodyTemperatureColdStartValueVampire",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureColdStartValueVampire, 1, 65536,  "From this temperature value, (if the player is a vampire) the player will receive the effect of hypothermia (1 lvl)");
        EM_Settings.BodyTemperatureHypothermia3                     = config.getFloat("130_BodyTemperatureHypothermia3",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia3, 1, 65536,  "From this temperature value, the player will receive the effect of hypothermia (3 lvl)");
        EM_Settings.BodyTemperatureHypothermia2                     = config.getFloat("131_BodyTemperatureHypothermia2",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia2, 1, 65536,  "From this temperature value, the player will receive the effect of hypothermia (2 lvl)");
        EM_Settings.BodyTemperatureHypothermia2Vampire              = config.getFloat("132_BodyTemperatureHypothermia2Vampire",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.BodyTemperatureHypothermia2Vampire, 1, 65536,  "From this temperature value, (if the player is a vampire) the player will receive the effect of hypothermia (2 lvl)");

        EM_Settings.TimeBelow10StartValue                      = config.getFloat("133_TimeBelow10StartValue",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10StartValue, 1, 65536,  "From this counter value, the player will receive the effect of frostbite (1 lvl), in seconds");
        EM_Settings.TimeBelow10Frostbite2                      = config.getFloat("134_TimeBelow10Frostbite2",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10Frostbite2, 1, 65536,  "From this counter value, the player will receive the effect of frostbite (2 lvl), in seconds");
        EM_Settings.TimeBelow10FrostbitePermanent              = config.getFloat("135_TimeBelow10FrostbitePermanent",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.TimeBelow10FrostbitePermanent, 1, 65536,  "From this counter value, the player will receive the effect of permanent frostbite, in seconds");

        EM_Settings.SanityStage0UpperBound              = config.getFloat("136_SanityStage0UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage0UpperBound, 1, 65536,  "If current sanity <= this value, and > SanityStage0LowerBound, the player will receive the effect of insanity (1 lvl)");
        EM_Settings.SanityStage0LowerBound              = config.getFloat("137_SanityStage0LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage0LowerBound, 1, 65536,  "See SanityStage0UpperBound");
        EM_Settings.SanityStage1UpperBound              = config.getFloat("138_SanityStage1UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage1UpperBound, 1, 65536,  "If current sanity <= this value, and > SanityStage1LowerBound, the player will receive the effect of insanity (2 lvl)");
        EM_Settings.SanityStage1LowerBound              = config.getFloat("139_SanityStage1LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage1LowerBound, 1, 65536,  "See SanityStage1UpperBound");
        EM_Settings.SanityStage2UpperBound              = config.getFloat("140_SanityStage2UpperBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage2UpperBound, 1, 65536,  "If current sanity <= this value, and > SanityStage2LowerBound, the player will receive the effect of insanity (3 lvl)");
        EM_Settings.SanityStage2LowerBound              = config.getFloat("141_SanityStage2LowerBound",CATEGORY_KOTMATROSS_FORK_CHANGES, EM_Settings.SanityStage2LowerBound, 1, 65536,  "See SanityStage2UpperBound");
