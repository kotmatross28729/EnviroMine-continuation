...
public class EM_ConfigHandler {
    ...
    /**
     * The version of the configs last loaded from file. This will be compared to the version number above when
     * determining whether a reset is necessary
     */
    ...
    public static void initProfile() {
        ...
        Iterator<PropertyBase> iterator = propTypes.values()
            .iterator();
        ...
        if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.ALL.getLevel()) {
            ...
            EnviroMine.logger
                .log(Level.INFO, "Loaded " + EM_Settings.dimensionProperties.size() + " dimension properties");
            EnviroMine.logger
                .log(Level.INFO, "Loaded " + EM_Settings.caveGenProperties.size() + " cave ore properties");
            EnviroMine.logger
                .log(Level.INFO, "Loaded " + EM_Settings.caveSpawnProperties.size() + " cave entity properties");
        }
    ...
    public static void loadHudItems() {
        if (!EM_Settings.enableAirQ && HUDRegistry.isActiveHudItem(HUDRegistry.getHudItemByID(HUD_ID_AIR_QUALITY))) {
        ...
        if (!EM_Settings.enableHydrate && HUDRegistry.isActiveHudItem(HUDRegistry.getHudItemByID(HUD_ID_HYDRATION))) {
        ...
        if (!EM_Settings.enableSanity && HUDRegistry.isActiveHudItem(HUDRegistry.getHudItemByID(HUD_ID_SANITY))) {
    ...
    public static int initConfig() {
        ...
        Iterator<PropertyBase> iterator = globalTypes.values()
            .iterator();
        ...
        int Total = EM_Settings.armorProperties.size() + EM_Settings.blockProperties.size()
            + EM_Settings.livingProperties.size()
            + EM_Settings.itemProperties.size()
            + EM_Settings.biomeProperties.size()
            + EM_Settings.dimensionProperties.size()
            + EM_Settings.caveGenProperties.size()
            + EM_Settings.caveSpawnProperties.size();
    ...
    private static void loadGlobalConfig(File file) {
        ...
        EM_Settings.shaftGen = config
            .get(
                ...
                "Enable Village MineShafts",
                EM_Settings.shaftGen,
                "Generates mineshafts in villages")
            .getBoolean(EM_Settings.shaftGen);
        EM_Settings.oldMineGen = config.get(
            CATEGORY_WORLD_GENERATION,
            ...
            .getBoolean(EM_Settings.oldMineGen);
        EM_Settings.gasGen = config.get(CATEGORY_WORLD_GENERATION, "Generate Gases", EM_Settings.gasGen)
            .getBoolean(EM_Settings.gasGen);
        // EM_Settings.disableCaves = config.get(catWorldGen, "Disable Cave Dimension", false).getBoolean(false); //
        // Moved to CaveBaseProperties
        // EM_Settings.limitElevatorY = config.get(catWorldGen, "Limit Elevator Height", true).getBoolean(true); //
        // Moved to CaveBaseProperties
        ...
        EM_Settings.LavaBlockAmbientTemperature = config.getFloat(
            "1-8_LavaBlockAmbientTemperature",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HbmGasMaskBreakMultiplier = config.getInt(
            "17_Hbm Gas Mask filter break multiplier",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxideGasDebugLogger = config.getBoolean(
            "20_SulfurDioxideGasDebugLogger",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxideSeverePoisoningAmplifier = config.getInt(
            "24_Sulfur Dioxide Severe Poisoning Amplifier",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxidePoisoningTime = config.getInt(
            "25_Sulfur Dioxide Poisoning Time",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxideSeverePoisoningTime = config.getInt(
            "26_Sulfur Dioxide Severe Poisoning Time",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxidePoisoningLevel = config.getInt(
            "27_Sulfur Dioxide Poisoning Level",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxideSeverePoisoningLevel = config.getInt(
            "28_Sulfur Dioxide Severe Poisoning Level",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.SulfurDioxidePoisoningChance = config.getInt(
            "29_Chance of Sulfur Dioxide Poisoning",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.CarbonMonoxidePoisoningAmplifier = config.getInt(
            "30_Carbon Monoxide Poisoning Amplifier",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.CarbonMonoxidePoisoningTime = config.getInt(
            "31_Carbon Monoxide Poisoning Time",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.CarbonMonoxidePoisoningLevel = config.getInt(
            "32_Carbon Monoxide Poisoning Level",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.CarbonMonoxidePoisoningChance = config.getInt(
            "33_Chance of Carbon Monoxide Poisoning",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfidePoisoningAmplifier = config.getInt(
            "34_Hydrogen Sulfide Poisoning Amplifier",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfideSeverePoisoningAmplifier = config.getInt(
            "35_Hydrogen Sulfide Severe Poisoning Amplifier",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfidePoisoningTime = config.getInt(
            "36_Hydrogen Sulfide Poisoning Time",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfideSeverePoisoningTime = config.getInt(
            "37_Hydrogen Sulfide Severe Poisoning Time",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfidePoisoningLevel = config.getInt(
            "38_Hydrogen Sulfide Poisoning Level",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfideSeverePoisoningLevel = config.getInt(
            "39_Hydrogen Sulfide Severe Poisoning Level",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.HydrogenSulfidePoisoningChance = config.getInt(
            "40_Chance of Hydrogen Sulfide Poisoning",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.enablePlayerRandomMobRender = config.getBoolean(
            "41_Player Insanity Random Mob Render",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
        ...
        EM_Settings.FrostyWaterTemperatureInfluence = config.getFloat(
            "70_FrostyWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.FrostyWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.DirtyColdWaterTemperatureInfluence = config.getFloat(
            "71_DirtyColdWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyColdWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.CleanColdWaterTemperatureInfluence = config.getFloat(
            "72_CleanColdWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanColdWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.SaltyWaterTemperatureInfluence = config.getFloat(
            "73_SaltyWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.SaltyWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.DirtyWaterTemperatureInfluence = config.getFloat(
            "74_DirtyWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.CleanWaterTemperatureInfluence = config.getFloat(
            "75_CleanWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.CleanWarmWaterTemperatureInfluence = config.getFloat(
            "76_CleanWarmWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWarmWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.DirtyWarmWaterTemperatureInfluence = config.getFloat(
            "77_DirtyWarmWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWarmWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");
        EM_Settings.HotWarmWaterTemperatureInfluence = config.getFloat(
            "78_HotWarmWaterTemperatureInfluence",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.HotWarmWaterTemperatureInfluence,
            -65536,
            65536,
            "When the player drinks this type of water, their temperature changes by this value");

        EM_Settings.WaterReducesTemperatureStartingValue = config.getFloat(
            "79_WaterReducesTemperatureStartingValue",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.WaterReducesTemperatureStartingValue,
            -65536,
            65536,
            "The temperature will change when the player drinks salt/clean/dirty water and his body temperature is >= this value");
        EM_Settings.ColdFrostyWaterReducesTemperatureStartingValue = config.getFloat(
            "80_ColdFrostyWaterReducesTemperatureStartingValue",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.ColdFrostyWaterReducesTemperatureStartingValue,
            -65536,
            65536,
            "The temperature will change when the player drinks cold/frosty water and his body temperature is >= this value");
        EM_Settings.WarmHotWaterReducesTemperatureStartingValue = config.getFloat(
            "81_WarmHotWaterReducesTemperatureStartingValue",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.WarmHotWaterReducesTemperatureStartingValue,
            -65536,
            65536,
            "The temperature will change when the player drinks warm/hot water and his body temperature is >= this value");

        EM_Settings.FrostyWaterHydrate = config.getFloat(
            "82_FrostyWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.FrostyWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydrate = config.getFloat(
            "83_DirtyColdWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyColdWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydrate = config.getFloat(
            "84_CleanColdWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanColdWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydrate = config.getFloat(
            "85_SaltyWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.SaltyWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydrate = config.getFloat(
            "86_DirtyWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        // in item props
        EM_Settings.CleanWaterHydrate = config.getFloat(
            "87_CleanWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydrate = config.getFloat(
            "88_CleanWarmWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWarmWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydrate = config.getFloat(
            "89_DirtyWarmWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWarmWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");
        EM_Settings.HotWaterHydrate = config.getFloat(
            "90_HotWaterHydrate",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.HotWaterHydrate,
            -65536,
            65536,
            "When a player drinks this type of water, their hydration will increase by that amount");

        EM_Settings.FrostyWaterHydratePlastic = config.getFloat(
            "91_FrostyWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.FrostyWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydratePlastic = config.getFloat(
            "92_DirtyColdWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyColdWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydratePlastic = config.getFloat(
            "93_CleanColdWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanColdWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydratePlastic = config.getFloat(
            "94_SaltyWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.SaltyWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydratePlastic = config.getFloat(
            "95_DirtyWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanWaterHydratePlastic = config.getFloat(
            "96_CleanWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydratePlastic = config.getFloat(
            "97_CleanWarmWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWarmWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydratePlastic = config.getFloat(
            "98_DirtyWarmWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWarmWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");
        EM_Settings.HotWaterHydratePlastic = config.getFloat(
            "99_HotWaterHydratePlastic",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.HotWaterHydratePlastic,
            -65536,
            65536,
            "When a player drinks this type of water from a plastic bottle, their hydration will increase by that amount");

        EM_Settings.FrostyWaterHydrateWorld = config.getFloat(
            "a-100_FrostyWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.FrostyWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyColdWaterHydrateWorld = config.getFloat(
            "a-101_DirtyColdWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyColdWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanColdWaterHydrateWorld = config.getFloat(
            "a-102_CleanColdWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanColdWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.SaltyWaterHydrateWorld = config.getFloat(
            "a-103_SaltyWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.SaltyWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWaterHydrateWorld = config.getFloat(
            "a-104_DirtyWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWaterHydrateWorld = config.getFloat(
            "a-105_CleanWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.CleanWarmWaterHydrateWorld = config.getFloat(
            "a-106_CleanWarmWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.CleanWarmWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.DirtyWarmWaterHydrateWorld = config.getFloat(
            "a-107_DirtyWarmWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.DirtyWarmWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        EM_Settings.HotWaterHydrateWorld = config.getFloat(
            "a-108_HotWaterHydrateWorld",
            CATEGORY_KOTMATROSS_FORK_CHANGES,
            EM_Settings.HotWaterHydrateWorld,
            -65536,
            65536,
            "When a player drinks this type of water from the world (water block), their hydration will increase by that amount");
        ...
        // EM_Settings.versionChecker = config.getBoolean("Version Checker", Configuration.CATEGORY_GENERAL, false,
        // "Displays a client-side chat message on login if there's an update available.");
        EM_Settings.loggerVerbosity = config.getInt(
            "Logger Verbosity",
            Configuration.CATEGORY_GENERAL,
            2,
            0,
            3,
            "Amount of messaging to dump to the console." + "\n0: No log messages are printed whatsoever"
                ...
                + "\n");
        EM_Settings.noNausea = config
            .get(Configuration.CATEGORY_GENERAL, "Blindness instead of Nausea", EM_Settings.noNausea)
            .getBoolean(EM_Settings.noNausea);
        ...
        EM_Settings.cauldronHeatingBlocks = config.get(
            Configuration.CATEGORY_GENERAL,
            "Cauldron Heating Blocks",
            EM_Settings.cauldronHeatingBlocks,
            ...
            .getStringList();
        EM_Settings.blockTempDropoffPower = config.getFloat(
            "Block Temperature Dropoff Power",
            Configuration.CATEGORY_GENERAL,
            0.75F,
            0.25F,
            2F,
            "How rapidly the temperature influence of blocks falls off with your distance from them. 2 is realistic for open areas; 1 for large enclosed areas, and lower for more claustrophobic areas. Classic EnviroMine used 0.5.");
        EM_Settings.scanRadius = config.getInt(
            "Environment scan radius",
            Configuration.CATEGORY_GENERAL,
            6,
            1,
            10,
            "Max distance blocks with temperature effects can affect you. Higher radius is more accurate, but more computationally expensive.");
        EM_Settings.auraRadius = config.getFloat(
            "Emission Aura Radius",
            Configuration.CATEGORY_GENERAL,
            0.5F,
            0F,
            5F,
            "A block with temperature effects maxes out its effects when you're this far from the block's center. ");
        ...
        EM_Settings.entityFailsafe = config.get(
            ...
            EM_Settings.entityFailsafe,
            "0 = No action, 1 = Limit to < 100 per 8x8 block area, 2 = Delete excessive entities & Dump physics (EMERGENCY ONLY)")
            .getInt(EM_Settings.entityFailsafe);

        // --------------- //
        // --- Potions --- //
        // --------------- //
        if (!LegacyHandler.getByKey("ConfigHandlerLegacy")
            .didRun()) {
            // Potion IDs
        ...
        EM_Settings.hypothermiaPotionID = config.get(CATEGORY_POTIONS, "Hypothermia", EM_Settings.hypothermiaPotionID)
            .getInt(EM_Settings.hypothermiaPotionID);
        EM_Settings.heatstrokePotionID = config.get(CATEGORY_POTIONS, "Heat Stroke", EM_Settings.heatstrokePotionID)
            .getInt(EM_Settings.heatstrokePotionID);
        EM_Settings.frostBitePotionID = config.get(CATEGORY_POTIONS, "Frostbite", EM_Settings.frostBitePotionID)
            .getInt(EM_Settings.frostBitePotionID);
        EM_Settings.dehydratePotionID = config.get(CATEGORY_POTIONS, "Dehydration", EM_Settings.dehydratePotionID)
            .getInt(EM_Settings.dehydratePotionID);
        EM_Settings.insanityPotionID = config.get(CATEGORY_POTIONS, "Insanity", EM_Settings.insanityPotionID)
            .getInt(EM_Settings.insanityPotionID);

        EM_Settings.enableFrostbiteGlobal = config
            .get(CATEGORY_POTIONS, "Enable Frostbite", EM_Settings.enableFrostbiteGlobal)
            .getBoolean();
        EM_Settings.enableHeatstrokeGlobal = config
            .get(CATEGORY_POTIONS, "Enable Heat Stroke", EM_Settings.enableHeatstrokeGlobal)
            .getBoolean();
        EM_Settings.enableHypothermiaGlobal = config
            .get(CATEGORY_POTIONS, "Enable Hypothermia", EM_Settings.enableHypothermiaGlobal)
            .getBoolean();
        EM_Settings.frostbitePermanent = config
            .get(CATEGORY_POTIONS, "Frostbite is permanent after enough time passes", EM_Settings.enableFrostbiteGlobal)
            .getBoolean(); // Convenience - AstroTibs

        // Config Options

        // Default Profile Override
        EM_Settings.profileSelected = config.get(CATEGORY_CONFIG, "Profile", EM_Settings.profileSelected)
            .getString();
    ...
    private static void loadProfileConfig(File file) {
        ...
        EM_Settings.enablePhysics = config
            .get(Configuration.CATEGORY_GENERAL, "Enable Physics", EM_Settings.enablePhysics, "Turn physics On/Off")
            .getBoolean(EM_Settings.enablePhysics);
        EM_Settings.enableLandslide = config
            .get(Configuration.CATEGORY_GENERAL, "Enable Physics Landslide", EM_Settings.enableLandslide)
            .getBoolean(EM_Settings.enableLandslide);
        EM_Settings.enableSanity = config.get(Configuration.CATEGORY_GENERAL, "Allow Sanity", EM_Settings.enableSanity)
            .getBoolean(EM_Settings.enableSanity);
        EM_Settings.enableHydrate = config
            .get(Configuration.CATEGORY_GENERAL, "Allow Hydration", EM_Settings.enableHydrate)
            .getBoolean(EM_Settings.enableHydrate);
        EM_Settings.enableBodyTemp = config
            .get(Configuration.CATEGORY_GENERAL, "Allow Body Temperature", EM_Settings.enableBodyTemp)
            .getBoolean(EM_Settings.enableBodyTemp);
        EM_Settings.enableAirQ = config
            .get(
                Configuration.CATEGORY_GENERAL,
                "Allow Air Quality",
                EM_Settings.enableAirQ,
                "True/False to turn Enviromine Trackers for Sanity, Air Quality, Hydration, and Body Temperature.")
            .getBoolean(EM_Settings.enableAirQ);
        EM_Settings.trackNonPlayer = config
            .get(
                Configuration.CATEGORY_GENERAL,
                "Track NonPlayer entities",
                EM_Settings.trackNonPlayer,
                "Track enviromine properties on Non-player entities(mobs & animals)")
            .getBoolean(EM_Settings.trackNonPlayer);
        EM_Settings.villageAssist = config
            .get(Configuration.CATEGORY_GENERAL, "Enable villager assistance", EM_Settings.villageAssist)
            .getBoolean(EM_Settings.villageAssist);
        EM_Settings.foodSpoiling = config
            .get(Configuration.CATEGORY_GENERAL, "Enable food spoiling", EM_Settings.foodSpoiling)
            .getBoolean(EM_Settings.foodSpoiling);
        EM_Settings.foodRotTime = config
            .get(Configuration.CATEGORY_GENERAL, "Default spoil time (days)", EM_Settings.foodRotTime)
            .getInt(EM_Settings.foodRotTime);
        EM_Settings.torchesBurn = config.get(Configuration.CATEGORY_GENERAL, "Torches burn", EM_Settings.torchesBurn)
            .getBoolean(EM_Settings.torchesBurn);
        EM_Settings.torchesGoOut = config
            .get(Configuration.CATEGORY_GENERAL, "Torches go out", EM_Settings.torchesGoOut)
            .getBoolean(EM_Settings.torchesGoOut);
        EM_Settings.flammableCoal = config
            .get(
                Configuration.CATEGORY_GENERAL,
                "Combustable Coal Ore",
                EM_Settings.flammableCoal,
                "If true, then coal can be ignited by fire sources")
            .getBoolean(EM_Settings.flammableCoal); // Added from request -- AstroTibs
        EM_Settings.randomizeInsanityPitch = config
            .get(
                Configuration.CATEGORY_GENERAL,
                "Randomize Insanity Pitch",
                EM_Settings.randomizeInsanityPitch,
                "Sounds you hear when under the influence of insanity have a randomized pitch")
            .getBoolean(EM_Settings.randomizeInsanityPitch);
        EM_Settings.catchFireAtHighTemps = config
            .get(
                Configuration.CATEGORY_GENERAL,
                "Catch fire at high temperatures",
                EM_Settings.catchFireAtHighTemps,
                "Spontaneously combust when your body temperature gets high enough")
            .getBoolean(EM_Settings.catchFireAtHighTemps);

        // Item capacities
        EM_Settings.gasMaskMax = config
            .get(Configuration.CATEGORY_GENERAL, "Capacity: Gas Mask", EM_Settings.gasMaskMax)
            .getInt(EM_Settings.gasMaskMax);
        EM_Settings.filterRestore = config
            .get(Configuration.CATEGORY_GENERAL, "Capacity: Gas Mask Filter Restore", EM_Settings.filterRestore)
            .getInt(EM_Settings.filterRestore);
        EM_Settings.camelPackMax = config
            .get(Configuration.CATEGORY_GENERAL, "Capacity: Camel Pack", EM_Settings.camelPackMax)
            .getInt(EM_Settings.camelPackMax);
        EM_Settings.gasMaskUpdateRestoreFraction = config.getFloat(
            "Restore Fraction: Gas Mask",
            Configuration.CATEGORY_GENERAL,
            1F,
            0F,
            1F,
            "Fraction of your air quality deficiency restored on an update check while wearing the gas mask. 1 is \"full.\" Set to less than 1 for a more gradual restoration and so players don't simply pop the mask on intermittently to get back full air quality.");
        ...
        EM_Settings.streamsDrink = config
            .get(
                CATEGORY_MOD_INTEGRATION,
                "Streams: River Drinking",
                EM_Settings.streamsDrink,
                "Allows players to drink from river blocks from the Streams mod")
            .getBoolean(EM_Settings.streamsDrink);
        EM_Settings.witcheryVampireImmunities = config.get(
            CATEGORY_MOD_INTEGRATION,
            "Witchery: Vampire Immunities",
            ...
            .getBoolean(EM_Settings.witcheryVampireImmunities);
        EM_Settings.witcheryWerewolfImmunities = config.get(
            CATEGORY_MOD_INTEGRATION,
            "Witchery: Werewolf Immunities",
            ...
            .getBoolean(EM_Settings.witcheryWerewolfImmunities);
        EM_Settings.matterOverdriveAndroidImmunities = config
            .get(
                CATEGORY_MOD_INTEGRATION,
                "Matter Overdrive: Android Immunities",
                EM_Settings.matterOverdriveAndroidImmunities,
                "Players who are in android form gain immunities to most EnviroMine effects")
            .getBoolean(EM_Settings.matterOverdriveAndroidImmunities);
        ...
        // Multipliers IDs
        EM_Settings.tempMult = config.get(CATEGORY_SPEED_MULTIPLIERS, "BodyTemp", EM_Settings.tempMult)
            .getDouble(EM_Settings.tempMult);
        EM_Settings.hydrationMult = config.get(CATEGORY_SPEED_MULTIPLIERS, "Hydration", EM_Settings.hydrationMult)
            .getDouble(EM_Settings.hydrationMult);
        EM_Settings.airMult = config.get(CATEGORY_SPEED_MULTIPLIERS, "AirQuality", EM_Settings.airMult)
            .getDouble(EM_Settings.airMult);
        EM_Settings.sanityMult = config.get(CATEGORY_SPEED_MULTIPLIERS, "Sanity", EM_Settings.sanityMult)
            .getDouble(EM_Settings.sanityMult);
        ...
        // Config Options
        Property genConfig = config.get(
            CATEGORY_CONFIG,
            "Generate Blank Configs",
            false,
            "Will attempt to find and generate blank configs for any custom items/blocks/etc loaded before "
                + EM_Settings.MOD_NAME
                + ". Pack developers are highly encouraged to enable this! (Resets back to false after use)");
        if (!EM_Settings.genConfigs) {
            EM_Settings.genConfigs = genConfig.getBoolean(false);
        }
        genConfig.set(false);

        Property genDefault = config.get(
            CATEGORY_CONFIG,
            "Generate Defaults",
            true,
            "Generates " + EM_Settings.MOD_NAME + "'s initial default files");
        if (!EM_Settings.genDefaults) {
        ...
        // Earthquake
        EM_Settings.enableQuakes = config.get(CATEGORY_EARTHQUAKES, "Enable Earthquakes", EM_Settings.enableQuakes)
            .getBoolean(EM_Settings.enableQuakes);
        EM_Settings.quakePhysics = config
            .get(
                CATEGORY_EARTHQUAKES,
                "Triggers Physics",
                EM_Settings.quakePhysics,
                "Can cause major lag at times (Requires main physics to be enabled)")
            .getBoolean(EM_Settings.quakePhysics);
        EM_Settings.quakeRarity = config.get(CATEGORY_EARTHQUAKES, "Rarity", EM_Settings.quakeRarity)
            .getInt(EM_Settings.quakeRarity);
    ...
    private static boolean isCFGFile(File file) {
        ...
        if (matcher.matches() && matcher.group(0)
            .toString()
            .toLowerCase() == MacCheck.toLowerCase()) {
            return false;
        }
    ...
    public static void CheckDir(File Dir) {
        ...
        if (Dir.exists()) {
            if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.ALL.getLevel())
                EnviroMine.logger.log(Level.INFO, "Dir already exists:" + Dir.getName());
            return;
        }
        ...
        try {
            ...
            if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.LOW.getLevel()) EnviroMine.logger
                .log(Level.ERROR, "Error occured while creating config directory: " + Dir.getAbsolutePath(), e);
        }
            ...
            try {
                ...
                for (int x = 0; x < catagory.size(); x++) {
                    ...
                    if (!CurCat.isEmpty() && CurCat.contains(Configuration.CATEGORY_SPLITTER)) {
                        ...
                        if (propTypes.containsKey(parent) && propTypes.get(parent)
                            .useCustomConfigs()) {
                ...
                if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.LOW.getLevel()) EnviroMine.logger.log(
                    Level.ERROR,
                    "FAILED TO LOAD CUSTOM CONFIG: " + customFiles.getName() + "\nNEW SETTINGS WILL BE IGNORED!",
                    e);
                return;
            }
        }
    ...
    public static String getProfileName(String profile) {
        return profile.substring(profilePath.length(), profile.length() - 1)
            .toUpperCase();
    }
    ...
    public static String SaveMyCustom(Object obj, Object type) {
        ...
        if (obj instanceof Block) {
            ...
            } else if (EntityRegistry.instance()
                .lookupModSpawn(en.getClass(), false) != null) {
                    id = EntityRegistry.instance()
                        .lookupModSpawn(en.getClass(), false)
                        .getModEntityId() + 128;
                } else {
                    ...
                    if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger
                        .log(Level.WARN, "Failed to add config entry. " + en.getCommandSenderName() + " has no ID!");
                }
