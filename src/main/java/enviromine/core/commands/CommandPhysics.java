...
public class CommandPhysics extends CommandBase {
        ...
        try {
            ...
            if (astring[0].equalsIgnoreCase(toggle)) {
                ...
                sender.addChatMessage(
                    new ChatComponentTranslation("commands.enviromine.envirophysic.statusText", "Enviromine", Status));
            } else {
                this.ShowUsage(sender);
                return;
            }
    ...
    public void togglePhy(ICommandSender sender) {
        ...
        if (EM_Settings.enablePhysics) {
            sender.addChatMessage(
                new ChatComponentTranslation("commands.enviromine.envirophysic.physics", "Enviromine", "On"));
        } else {
            sender.addChatMessage(
                new ChatComponentTranslation("commands.enviromine.envirophysic.physics", "Enviromine", "Off"));
        }
    }
