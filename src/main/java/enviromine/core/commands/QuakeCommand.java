...
public class QuakeCommand extends CommandBase
{
	...
	public void processCommand(ICommandSender sender, String[] astring)
	{
		...
		if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger.log(Level.INFO, sender.getCommandSenderName() + " spawned earthquake at (" + x + "," + z + ")");
	}
}
