...
public abstract class MineSegment
{
	...
	public void setBlock(int x, int y, int z, Block block, int meta)
	{
		...
		{
			if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger.log(Level.WARN, this.getClass().getSimpleName() + " tried to place block out of bounds!");
			return;
		}
