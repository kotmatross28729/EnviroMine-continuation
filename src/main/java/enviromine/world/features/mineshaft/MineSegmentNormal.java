...
public class MineSegmentNormal extends MineSegment {
    ...
    public MineSegmentNormal(World world, int x, int y, int z, int rotation, MineshaftBuilder builder,
        boolean hasFloor) {
    ...
    public boolean build() {
        ...
        if ((getBlock(2, 1, 0) == Blocks.fence && getBlock(2, 1, -1) == Blocks.air)
        ...
        if ((getBlock(0, 1, 2) == Blocks.fence && getBlock(-1, 1, 2) == Blocks.air)
