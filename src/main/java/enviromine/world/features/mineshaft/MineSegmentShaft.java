...
public class MineSegmentShaft extends MineSegment {
    ...
    public MineSegmentShaft(World world, int x, int y, int z, int rotation, MineshaftBuilder builder,
        boolean hasFloor) {
    ...
    public boolean build() {
        ...
        if (hasFloor && ((getBlock(2, 1, 0) == Blocks.fence && getBlock(2, 1, -1) == Blocks.air)
            || getBlock(2, 1, -1) == Blocks.air)) {
        ...
        if (hasFloor && ((getBlock(0, 1, 2) == Blocks.fence && getBlock(-1, 1, 2) == Blocks.air)
            || getBlock(-1, 1, 2) == Blocks.air)) {
        ...
        if (hasFloor && ((getBlock(2, 1, 4) == Blocks.fence && getBlock(2, 1, 5) == Blocks.air)
            || getBlock(2, 1, 5) == Blocks.air)) {
        ...
        if (hasFloor && ((getBlock(4, 1, 2) == Blocks.fence && getBlock(5, 1, 2) == Blocks.air)
            || getBlock(5, 1, 2) == Blocks.air)) {
    ...
    public boolean canBuild() {
        if (this.getBlock(2, 0, 1) == Blocks.ladder || this.getBlock(1, 0, 2) == Blocks.ladder
            || this.getBlock(2, 0, 3) == Blocks.ladder
            || this.getBlock(3, 0, 2) == Blocks.ladder) {
            return false;
        } else {
