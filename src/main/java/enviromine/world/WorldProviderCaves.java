...
public class WorldProviderCaves extends WorldProvider
{
	...
	public IChunkProvider createChunkGenerator()
	{
		...
		if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.ALL.getLevel()) EnviroMine.logger.log(Level.INFO, "Loading cave seed from: " + EM_Settings.worldDir.getAbsolutePath());
		...
		{
			if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.LOW.getLevel()) EnviroMine.logger.log(Level.ERROR, "Failed to save CaveDimension data to file: " + dimData.getAbsolutePath(), e);
		}
