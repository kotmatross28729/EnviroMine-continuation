...
public class BlockBurningCoal extends Block implements ITileEntityProvider {
    ...
    public BlockBurningCoal(Material mat) {
        ...
        this.setHardness(3.0F)
            ...
            .setBlockTextureName("enviromine:burning_coal")
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        for (int i = 0; i < ForgeDirection.VALID_DIRECTIONS.length; i++) {
            ...
            if (EM_Settings.noGases) {
                coalTile.fuel -= 1;
            } else if (world.rand.nextInt(20) == 0 && (world.getBlock(xOff, yOff, zOff) == Blocks.air
                || world.getBlock(xOff, yOff, zOff) instanceof BlockGas)) {
    ...
    private void tryCatchFire(World world, int x, int y, int z, int p_149841_5_, Random random, int chance,
        ForgeDirection face) {
        int j1 = world.getBlock(x, y, z)
