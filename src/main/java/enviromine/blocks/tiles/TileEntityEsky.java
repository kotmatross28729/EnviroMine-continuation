...
public class TileEntityEsky extends TileEntity implements IInventory {
    ...
    public void updateEntity() {
        ...
        if (++this.field_145974_k % 20 * 4 == 0) {
            this.worldObj
                .addBlockEvent(this.xCoord, this.yCoord, this.zCoord, Blocks.ender_chest, 1, this.numPlayersUsing);
        }
        ...
        if (this.numPlayersUsing > 0 && this.field_145972_a == 0.0F) {
            ...
            // this.worldObj.playSoundEffect(d0, (double)this.yCoord + 0.5D, d1, "random.chestopen", 0.5F,
        ...
        if (this.numPlayersUsing == 0 && this.field_145972_a > 0.0F
            || this.numPlayersUsing > 0 && this.field_145972_a < 1.0F) {
            ...
            if (this.field_145972_a < f1 && f2 >= f1) {
                ...
                // this.worldObj.playSoundEffect(d1, (double)this.yCoord + 0.5D, d2, "random.chestclosed", 0.5F,
                // this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
                this.worldObj.playSoundEffect(
                    d1,
                    (double) this.yCoord + 0.5D,
                    d2,
                    "enviromine:eskyclose",
                    0.5F,
                    this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
