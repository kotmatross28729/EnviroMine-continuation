...
public class ItemProperties_NTM {
    ...
    public static void registerItemsNTM(Configuration config, String category, String[] IPName, Item item) {
        ...
        if (item instanceof EnviroItemPolymerWaterBottle enviroItemWaterBottle) {
            ...
            config.get(category, IPName[5], 0D)
                .getDouble(0D);
            config.get(category, IPName[6], 0.3D)
                .getDouble(0.3D); // It's 40/60, so
            config.get(category, IPName[7], 0D)
                .getDouble(0D);
            config.get(category, IPName[8], 30D)
                .getDouble(30D); // guh
            config.get(category, IPName[9], 20D)
                .getDouble(20D);
            config.get(category, IPName[10], 38.0D)
                .getDouble(38.0D);
            config.get(category, IPName[11], 0)
                .getInt(0);
            config.get(category, IPName[12], "")
            ...
            || item == ModItems.can_creature
            || item == ModItems.can_redbomb
            || item == ModItems.can_mrsugar
            || item == ModItems.can_overcharge
            || item == ModItems.can_luna
            || item == ModItems.can_bepis
            || item == ModItems.can_breen
            || item == ModItems.bottle_nuka
            || item == ModItems.bottle_cherry
            || item == ModItems.bottle_quantum
            ...
            || item == ModItems.bottle2_fritz) {
                ...
                config.get(category, IPName[5], 0D)
                    .getDouble(0D);
                config.get(category, IPName[6], -0.15D)
                    .getDouble(-0.15D);
                config.get(category, IPName[7], 0D)
                    .getDouble(0D);
                config.get(category, IPName[8], 20D)
                    .getDouble(20D); // beer sanity boost
                config.get(category, IPName[9], 22D)
                    .getDouble(22D);
                config.get(category, IPName[10], 36.6D)
                    .getDouble(36.6D);
                config.get(category, IPName[11], 0)
                ...
                config.get(category, IPName[5], 0D)
                    .getDouble(0D);
                config.get(category, IPName[6], item == ModItems.coffee ? 0.1D : 0.6D)
                    .getDouble(item == ModItems.coffee ? 0.1D : 0.6D);
                config.get(category, IPName[7], 0D)
                    .getDouble(0D);
                config.get(category, IPName[8], item == ModItems.coffee ? 5D : 10D)
                ...
                config.get(category, IPName[6], 0D)
                    .getDouble(0D);
                config.get(category, IPName[7], item == ModItems.crackpipe ? -1D : -10D)
                    .getDouble(item == ModItems.crackpipe ? -1D : -10D);
                config.get(category, IPName[8], item == ModItems.crackpipe ? 40D : 30D)
                ...
                config.get(category, IPName[7], 0D)
                    .getDouble(0D);
                config.get(category, IPName[8], item == ModItems.xanax ? 10D : item == ModItems.fmn ? 50D : 100D)
                ...
                config.get(category, IPName[4], aDefault)
                    .getDouble(aDefault);
                config.get(category, IPName[5], Digammalevel < 0 ? Digammalevel : 0D)
                    .getDouble(Digammalevel < 0 ? Digammalevel : 0D);
                config.get(category, IPName[6], 0D)
                    .getDouble(0D);
                config.get(category, IPName[7], 0D)
                    .getDouble(0D);
