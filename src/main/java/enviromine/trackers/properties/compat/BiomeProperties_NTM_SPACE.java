...
public class BiomeProperties_NTM_SPACE {
    ...
    public static void registerNTMSpaceBiomes(Configuration config, BiomeGenBase biome, String[] BOName,
        String biomeWater, double biomeTemp, double temp, double sanity, double water, double air,
        double TemperatureMultiplier, double DAWN_TEMPERATURE, double DAY_TEMPERATURE, double DUSK_TEMPERATURE,
        double NIGHT_TEMPERATURE, double TemperatureRainDecrease, double TemperatureThunderDecrease,
        boolean TemperatureRainBool, boolean TemperatureThunderBool, double TemperatureShadeDecrease,
        double ambientTemp_TERRAFORMED, double DAWN_TEMPERATURE_TERRAFORMED, double DAY_TEMPERATURE_TERRAFORMED,
        double DUSK_TEMPERATURE_TERRAFORMED, double NIGHT_TEMPERATURE_TERRAFORMED,
        double EARLY_SPRING_TEMPERATURE_DECREASE, double EARLY_SUMMER_TEMPERATURE_DECREASE,
        double EARLY_WINTER_TEMPERATURE_DECREASE, double EARLY_AUTUMN_TEMPERATURE_DECREASE,
        double MID_SPRING_TEMPERATURE_DECREASE, double MID_SUMMER_TEMPERATURE_DECREASE,
        double MID_WINTER_TEMPERATURE_DECREASE, double MID_AUTUMN_TEMPERATURE_DECREASE,
        double LATE_SPRING_TEMPERATURE_DECREASE, double LATE_SUMMER_TEMPERATURE_DECREASE,
        double LATE_WINTER_TEMPERATURE_DECREASE, double LATE_AUTUMN_TEMPERATURE_DECREASE, double tempRate_DAWN,
        double tempRate_DAY, double tempRate_DUSK, double tempRate_NIGHT, boolean tempRate_HARD,
        double TemperatureWaterDecrease, double dropSpeedWater, double dropSpeedRain, double dropSpeedThunder) {
