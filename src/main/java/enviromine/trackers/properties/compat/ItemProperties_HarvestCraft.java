...
public class ItemProperties_HarvestCraft {
     ...
     * item == ItemRegistry.melonjuiceItem || item == ItemRegistry.melonsmoothieItem || item ==
     ...
     * ||
     * item == ItemRegistry.pumpkinsoupItem || item == ItemRegistry.carrotsoupItem || item ==
     * ItemRegistry.potatosoupItem ||
     * item == ItemRegistry.chickennoodlesoupItem || item == ItemRegistry.potroastItem || item ==
     * ItemRegistry.spidereyesoupItem ||
