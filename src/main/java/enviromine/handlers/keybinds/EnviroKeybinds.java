...
public class EnviroKeybinds {
    ...
    public static void Init() {
        reloadConfig = new KeyBinding(
            StatCollector.translateToLocal("keybinds.enviromine.reload"),
            Keyboard.KEY_K,
            "EnviroMine");
        addRemove = new KeyBinding(
            StatCollector.translateToLocal("keybinds.enviromine.addremove"),
            Keyboard.KEY_J,
            "EnviroMine");
        menu = new KeyBinding(
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        if (menu.getIsKeyPressed()) {
            Minecraft.getMinecraft()
                .displayGuiScreen(new EM_Gui_Menu());
        }
