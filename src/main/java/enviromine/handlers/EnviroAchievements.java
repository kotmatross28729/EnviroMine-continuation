...
public class EnviroAchievements {
    ...
    public static Achievement itsPitchBlack; // @ Travel 250 blocks in complete darkness in the cave dimension or
                                             // encounter the Grue
    ...
    public static void InitAchievements() {
        ...
        // Crafting
        safetyFirst = new Achievement(
            "enviromine.SafetyFirst",
            "enviromine.SafetyFirst",
            -2,
            -2,
            ObjectHandler.hardHat,
            AchievementList.buildWorkBench).registerStat();
        breatheEasy = new Achievement(
            "enviromine.BreatheEasy",
            "enviromine.BreatheEasy",
            -1,
            -2,
            ObjectHandler.gasMask,
            AchievementList.buildWorkBench).registerStat();
        keepYourCool = new Achievement(
            "enviromine.KeepYourCool",
            "enviromine.KeepYourCool",
            0,
            -2,
            ObjectHandler.camelPack,
            AchievementList.buildWorkBench).registerStat();
        // Status effects
        tradingFavours = new Achievement(
            "enviromine.TradingFavours",
            "enviromine.TradingFavours",
            -2,
            -1,
            Items.emerald,
            (Achievement) null).registerStat();
        thermalShock_dummy = new Achievement(
            "enviromine.ThermalShockDummy",
            "enviromine.ThermalShockDummy",
            -1,
            -1,
            Blocks.flowing_lava,
            (Achievement) null).registerStat();
        thermalShock = new Achievement(
            "enviromine.ThermalShock",
            "enviromine.ThermalShock",
            -1,
            -1,
            Items.snowball,
            (Achievement) null).registerStat();
        winterIsComing = new Achievement(
            "enviromine.WinterIsComing",
            "enviromine.WinterIsComing",
            0,
            -1,
            Blocks.snow,
            (Achievement) null).registerStat();
        iNeededThat = new Achievement(
            "enviromine.INeededThat",
            "enviromine.INeededThat",
            1,
            -1,
            Items.shears,
            (Achievement) null).registerStat();
        hardBoiled = new Achievement(
            "enviromine.HardBoiled",
            "enviromine.HardBoiled",
            2,
            -1,
            Items.egg,
            (Achievement) null).registerStat();
        mindOverMatter = new Achievement(
            "enviromine.MindOverMatter",
            "enviromine.MindOverMatter",
            3,
            -1,
            Items.ender_eye,
            AchievementList.buildSword).registerStat();
        // Mining/Caving
        funwaysFault = new Achievement(
            "enviromine.FunwaysFault",
            "enviromine.FunwaysFault",
            -2,
            0,
            Blocks.cobblestone,
            AchievementList.buildPickaxe).registerStat();
        thatJustHappened = new Achievement(
            "enviromine.ThatJustHappened",
            "enviromine.ThatJustHappened",
            -1,
            0,
            Blocks.fire,
            AchievementList.buildPickaxe).registerStat();
        proMiner = new Achievement(
            "enviromine.ProMiner",
            "enviromine.ProMiner",
            0,
            0,
            ...
            AchievementList.buildPickaxe).registerStat();
        boreToTheCore = new Achievement(
            "enviromine.BoreToTheCore",
            "enviromine.BoreToTheCore",
            1,
            0,
            ObjectHandler.elevator,
            AchievementList.diamonds).registerStat();
        intoTheDarkness = new Achievement(
            "enviromine.IntoTheDarkness",
            "enviromine.IntoTheDarkness",
            2,
            0,
            Blocks.torch,
            boreToTheCore).registerStat();
        itsPitchBlack = new Achievement(
            "enviromine.ItsPitchBlack",
            "enviromine.ItsPitchBlack",
            3,
            0,
            Items.skull,
            boreToTheCore).registerStat();
        // Miscellaneous
        tenSecondRule = new Achievement(
            "enviromine.TenSecondRule",
            "enviromine.TenSecondRule",
            -2,
            1,
            ObjectHandler.rottenFood,
            (Achievement) null).registerStat();
        ohGodWhy = new Achievement(
            "enviromine.OhGodWhy",
            "enviromine.OhGodWhy",
            -1,
            1,
        ...
        // Unimplemented
        // medicalMarvels = new Achievement("enviromine.MedicalMarvels", "enviromine.MedicalMarvels", 0, 3,
        // Items.potionitem, null).registerStat();
        // suckItUpPrincess = new Achievement("enviromine.SuckItUpPrincess", "enviromine.SuckItUpPrincess", 1, 3,
        // Items.bone, AchievementList.buildSword).registerStat();
        ...
        page = new AchievementPage(
            ...
            keepYourCool,
            thermalShock_dummy,
            thermalShock// , keepYourCool, medicalMarvels, suckItUpPrincess
        );
