...
public class RotHandler
{
	...
	public static void rotInvo(World world, IInventory inventory)
	{
		...
		{
			if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.NORMAL.getLevel()) EnviroMine.logger.log(Level.ERROR, "An error occured while attempting to rot inventory:", e);
			return;
		}
	}
}
