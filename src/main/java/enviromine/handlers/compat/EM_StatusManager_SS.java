...
public class EM_StatusManager_SS {
	...
	public static float getTempDecreaseSeason(
			EntityLivingBase entityLiving,
			float biomeTemperature,
			float biome_EARLY_SPRING_TEMPERATURE_DECREASE,
			float biome_MID_SPRING_TEMPERATURE_DECREASE,
			float biome_LATE_SPRING_TEMPERATURE_DECREASE,
			float biome_EARLY_SUMMER_TEMPERATURE_DECREASE,
			float biome_MID_SUMMER_TEMPERATURE_DECREASE,
			float biome_LATE_SUMMER_TEMPERATURE_DECREASE,
			float biome_EARLY_AUTUMN_TEMPERATURE_DECREASE,
			float biome_MID_AUTUMN_TEMPERATURE_DECREASE,
			float biome_LATE_AUTUMN_TEMPERATURE_DECREASE,
			float biome_EARLY_WINTER_TEMPERATURE_DECREASE,
			float biome_MID_WINTER_TEMPERATURE_DECREASE,
			float biome_LATE_WINTER_TEMPERATURE_DECREASE
	) {
