...
public class EM_StatusManager_NTM_SPACE {
	...
	public static float TemperatureChangeSpace(
			EntityLivingBase entityLiving,
			float currentTime,
			float biome_DAWN_TEMPERATURE_TERRAFORMED,
			float biome_DAY_TEMPERATURE_TERRAFORMED,
			float biome_DUSK_TEMPERATURE_TERRAFORMED,
			float biome_NIGHT_TEMPERATURE_TERRAFORMED,
			float biome_DAWN_TEMPERATURE,
			float biome_DAY_TEMPERATURE,
			float biome_DUSK_TEMPERATURE,
	...
	public static float TemperatureRateChangeSpace(
			EntityLivingBase entityLiving,
			float currentTime,
			float tempRate_DAWN,
			float tempRate_DAY,
		...
		temperatureRate = calculateTemperatureChangeSpace(currentTime, phasePeriod, tempRate_DAWN, tempRate_DAY, tempRate_DUSK, tempRate_NIGHT);
