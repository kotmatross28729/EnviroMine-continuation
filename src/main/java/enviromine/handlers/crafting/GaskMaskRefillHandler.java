        ...
        if (mask == null || maskFill >= maskMax) {
            ...
            if ((maskFill + (filters.size() * filterFill)) <= maskMax) {
                output.getTagCompound()
                    .setInteger(EM_Settings.GAS_MASK_FILL_TAG_KEY, (maskFill + (filters.size() * filterFill)));
            } else {
                output.getTagCompound()
                    .setInteger(EM_Settings.GAS_MASK_FILL_TAG_KEY, maskMax);
            }
