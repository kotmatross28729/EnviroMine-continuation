...
import enviromine.blocks.BlockFakeTorch;
...
public class ObjectHandler {
    ...
    public static void initBlocks() {
        ...
        radioactive_cold_Water = new EnviroMineWaterFluid("radioactive_cold_Water").setTemperature(283)
            .setDensity(1040); // 9,85 °C, 1040 kg/m^3
        dirty_cold_Water = new EnviroMineWaterFluid("dirty_cold_Water").setTemperature(283); // 9,85 °C
        salty_cold_Water = new EnviroMineWaterFluid("salty_cold_Water").setTemperature(283)
            .setDensity(1025); // 9,85 °C , 1025 kg/m^3
        clean_cold_Water = new EnviroMineWaterFluid("clean_cold_Water").setTemperature(283); // 9,85 °C
        radioactive_Water = new EnviroMineWaterFluid("radioactive_Water").setDensity(1050); // 26,85 °C, 1050 kg/m^3
        ...
        radioactive_warm_Water = new EnviroMineWaterFluid("radioactive_warm_Water").setTemperature(313)
            .setDensity(1060); // 39,85 °C, 1060 kg/m^3
        dirty_warm_Water = new EnviroMineWaterFluid("dirty_warm_Water").setTemperature(313); // 39,85 °C
        salty_warm_Water = new EnviroMineWaterFluid("salty_warm_Water").setTemperature(313)
            .setDensity(1020); // 39,85 °C , 1020 kg/m^3
        clean_warm_Water = new EnviroMineWaterFluid("clean_warm_Water").setTemperature(313); // 39,85 °C
        radioactive_hot_Water = new EnviroMineWaterFluid("radioactive_hot_Water").setTemperature(327)
            .setDensity(1070); // 53,85 °C, 1070 kg/m^3
        ...
        block_radioactive_frosty_Water = new BlockEnviroMineWater(radioactive_frosty_Water, Material.water)
            .setBlockName("block_radioactive_frosty_Water")
            .setHardness(100.0f);
        block_frosty_Water = new BlockEnviroMineWater(frosty_Water, Material.water).setBlockName("block_frosty_Water")
            .setHardness(100.0f);
        block_radioactive_cold_Water = new BlockEnviroMineWater(radioactive_cold_Water, Material.water)
            .setBlockName("block_radioactive_cold_Water")
            .setHardness(100.0f);
        block_dirty_cold_Water = new BlockEnviroMineWater(dirty_cold_Water, Material.water)
            .setBlockName("block_dirty_cold_Water")
            .setHardness(100.0f);
        block_salty_cold_Water = new BlockEnviroMineWater(salty_cold_Water, Material.water)
            .setBlockName("block_salty_cold_Water")
            .setHardness(100.0f);
        block_clean_cold_Water = new BlockEnviroMineWater(clean_cold_Water, Material.water)
            .setBlockName("block_clean_cold_Water")
            .setHardness(100.0f);
        block_radioactive_Water = new BlockEnviroMineWater(radioactive_Water, Material.water)
            .setBlockName("block_radioactive_Water")
            .setHardness(100.0f);
        block_dirty_Water = new BlockEnviroMineWater(dirty_Water, Material.water).setBlockName("block_dirty_Water")
            .setHardness(100.0f);
        block_salty_Water = new BlockEnviroMineWater(salty_Water, Material.water).setBlockName("block_salty_Water")
            .setHardness(100.0f);
        block_radioactive_warm_Water = new BlockEnviroMineWater(radioactive_warm_Water, Material.water)
            .setBlockName("block_radioactive_warm_Water")
            .setHardness(100.0f);
        block_dirty_warm_Water = new BlockEnviroMineWater(dirty_warm_Water, Material.water)
            .setBlockName("block_dirty_warm_Water")
            .setHardness(100.0f);
        block_salty_warm_Water = new BlockEnviroMineWater(salty_warm_Water, Material.water)
            .setBlockName("block_salty_warm_Water")
            .setHardness(100.0f);
        block_clean_warm_Water = new BlockEnviroMineWater(clean_warm_Water, Material.water)
            .setBlockName("block_clean_warm_Water")
            .setHardness(100.0f);
        block_radioactive_hot_Water = new BlockEnviroMineWater(radioactive_hot_Water, Material.water)
            .setBlockName("block_radioactive_hot_Water")
            .setHardness(100.0f);
        block_hot_Water = new BlockEnviroMineWater(hot_Water, Material.water).setBlockName("block_hot_Water")
            .setHardness(100.0f);

        gasMat = new MaterialGas(MapColor.airColor);
        gasBlock = new BlockGas(gasMat).setBlockName("enviromine.gas")
            .setCreativeTab(EnviroMine.enviroTab)
            .setBlockTextureName("enviromine:gas_block");
        fireGasBlock = new BlockGas(gasMat).setBlockName("enviromine.firegas")
            .setCreativeTab(EnviroMine.enviroTab)
            .setBlockTextureName("enviromine:gas_block")
            .setLightLevel(1.0F);

        elevatorMat = new MaterialElevator(MapColor.ironColor);
        elevator = new BlockElevator(elevatorMat).setBlockName("enviromine.elevator")
            .setCreativeTab(EnviroMine.enviroTab)
            .setBlockTextureName("iron_block");

        davyLampBlock = new BlockDavyLamp(Material.redstoneLight).setLightLevel(1.0F)
            .setBlockName("enviromine.davy_lamp")
            .setCreativeTab(EnviroMine.enviroTab);
        davyLamp = new ItemDavyLamp(davyLampBlock).setUnlocalizedName("enviromine.davylamp")
            .setCreativeTab(EnviroMine.enviroTab);
    ...
    public static void initItems() {
        ...
        radioactive_frosty_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.RADIOACTIVE_FROSTY)
            .setMaxStackSize(1)
            .setUnlocalizedName("enviromine.radioactive_frosty_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        frosty_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.FROSTY).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.frosty_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);

        radioactive_cold_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.RADIOACTIVE_COLD)
            .setMaxStackSize(1)
            .setUnlocalizedName("enviromine.radioactive_cold_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        dirty_cold_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.DIRTY_COLD).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.dirty_cold_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        salty_cold_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.SALTY_COLD).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.salty_cold_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        clean_cold_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.CLEAN_COLD).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.clean_cold_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);

        radioactive_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.RADIOACTIVE).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.radioactive_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        dirty_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.DIRTY).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.dirty_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        salty_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.SALTY).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.salty_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);

        radioactive_warm_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.RADIOACTIVE_WARM)
            .setMaxStackSize(1)
            .setUnlocalizedName("enviromine.radioactive_warm_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        dirty_warm_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.DIRTY_WARM).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.dirty_warm_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        salty_warm_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.SALTY_WARM).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.salty_warm_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        clean_warm_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.CLEAN_WARM).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.clean_warm_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);

        radioactive_hot_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.RADIOACTIVE_HOT)
            .setMaxStackSize(1)
            .setUnlocalizedName("enviromine.radioactive_hot_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);
        hot_WaterBottle = new EnviroItemWaterBottle(WaterUtils.WATER_TYPES.HOT).setMaxStackSize(1)
            .setUnlocalizedName("enviromine.hot_WaterBottle")
            .setCreativeTab(EnviroMine.enviroTab);

        /// -------

        bucket_radioactive_frosty_Water = new ItemModBucket(block_radioactive_frosty_Water)
            .setUnlocalizedName("bucket_radioactive_frosty_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_radioactive_frosty_Water");
        bucket_frosty_Water = new ItemModBucket(block_frosty_Water).setUnlocalizedName("bucket_frosty_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_frosty_Water");
        bucket_radioactive_cold_Water = new ItemModBucket(block_radioactive_cold_Water)
            .setUnlocalizedName("bucket_radioactive_cold_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_radioactive_cold_Water");
        bucket_dirty_cold_Water = new ItemModBucket(block_dirty_cold_Water)
            .setUnlocalizedName("bucket_dirty_cold_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_dirty_cold_Water");
        bucket_salty_cold_Water = new ItemModBucket(block_salty_cold_Water)
            .setUnlocalizedName("bucket_salty_cold_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_salty_cold_Water");
        bucket_clean_cold_Water = new ItemModBucket(block_clean_cold_Water)
            .setUnlocalizedName("bucket_clean_cold_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_clean_cold_Water");
        bucket_radioactive_Water = new ItemModBucket(block_radioactive_Water)
            .setUnlocalizedName("bucket_radioactive_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_radioactive_Water");
        bucket_dirty_Water = new ItemModBucket(block_dirty_Water).setUnlocalizedName("bucket_dirty_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_dirty_Water");
        bucket_salty_Water = new ItemModBucket(block_salty_Water).setUnlocalizedName("bucket_salty_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_salty_Water");
        bucket_radioactive_warm_Water = new ItemModBucket(block_radioactive_warm_Water)
            .setUnlocalizedName("bucket_radioactive_warm_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_radioactive_warm_Water");
        bucket_dirty_warm_Water = new ItemModBucket(block_dirty_warm_Water)
            .setUnlocalizedName("bucket_dirty_warm_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_dirty_warm_Water");
        bucket_salty_warm_Water = new ItemModBucket(block_salty_warm_Water)
            .setUnlocalizedName("bucket_salty_warm_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_salty_warm_Water");
        bucket_clean_warm_Water = new ItemModBucket(block_clean_warm_Water)
            .setUnlocalizedName("bucket_clean_warm_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_clean_warm_Water");
        bucket_radioactive_hot_Water = new ItemModBucket(block_radioactive_hot_Water)
            .setUnlocalizedName("bucket_radioactive_hot_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_radioactive_hot_Water");
        bucket_hot_Water = new ItemModBucket(block_hot_Water).setUnlocalizedName("bucket_hot_Water")
            .setContainerItem(Items.bucket)
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:bucket_hot_Water");

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(radioactive_frosty_Water, 1000),
            new ItemStack(bucket_radioactive_frosty_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(frosty_Water, 1000),
            new ItemStack(bucket_frosty_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(radioactive_cold_Water, 1000),
            new ItemStack(bucket_radioactive_cold_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(dirty_cold_Water, 1000),
            new ItemStack(bucket_dirty_cold_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(salty_cold_Water, 1000),
            new ItemStack(bucket_salty_cold_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(clean_cold_Water, 1000),
            new ItemStack(bucket_clean_cold_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(radioactive_Water, 1000),
            new ItemStack(bucket_radioactive_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(dirty_Water, 1000),
            new ItemStack(bucket_dirty_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(salty_Water, 1000),
            new ItemStack(bucket_salty_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(radioactive_warm_Water, 1000),
            new ItemStack(bucket_radioactive_warm_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(dirty_warm_Water, 1000),
            new ItemStack(bucket_dirty_warm_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(salty_warm_Water, 1000),
            new ItemStack(bucket_salty_warm_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(clean_warm_Water, 1000),
            new ItemStack(bucket_clean_warm_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(radioactive_hot_Water, 1000),
            new ItemStack(bucket_radioactive_hot_Water),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(hot_Water, 1000),
        ...
        airFilter = new Item().setMaxStackSize(16)
            .setUnlocalizedName("enviromine.airfilter")
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:air_filter");
        rottenFood = new RottenFood(1).setMaxStackSize(64)
            .setUnlocalizedName("enviromine.rottenfood")
            .setCreativeTab(EnviroMine.enviroTab)
            .setTextureName("enviromine:rot");
        spoiledMilk = new ItemSpoiledMilk().setUnlocalizedName("enviromine.spoiledmilk")
            .setCreativeTab(EnviroMine.enviroTab)
        ...
        gasMask = (ItemArmor) new EnviroArmor(EM_Material, 4, 0).setTextureName("gas_mask")
            ...
            .setCreativeTab(null);
        hardHat = (ItemArmor) new EnviroArmor(EM_Material, 4, 0).setTextureName("hard_hat")
            .setUnlocalizedName("enviromine.hardhat")
            .setCreativeTab(EnviroMine.enviroTab);
    }
    ...
    public static ItemStack getItemStackFromWaterType(WaterUtils.WATER_TYPES type) {
        switch (type) {
            case RADIOACTIVE_FROSTY -> {
                return new ItemStack(radioactive_frosty_WaterBottle);
            }
            case FROSTY -> {
                return new ItemStack(frosty_WaterBottle);
            }

            case RADIOACTIVE_COLD -> {
                return new ItemStack(radioactive_cold_WaterBottle);
            }
            case DIRTY_COLD -> {
                return new ItemStack(dirty_cold_WaterBottle);
            }
            case SALTY_COLD -> {
                return new ItemStack(salty_cold_WaterBottle);
            }
            case CLEAN_COLD -> {
                return new ItemStack(clean_cold_WaterBottle);
            }

            case RADIOACTIVE -> {
                return new ItemStack(radioactive_WaterBottle);
            }
            case DIRTY -> {
                return new ItemStack(dirty_WaterBottle);
            }
            case SALTY -> {
                return new ItemStack(salty_WaterBottle);
            }

            case RADIOACTIVE_WARM -> {
                return new ItemStack(radioactive_warm_WaterBottle);
            }
            case DIRTY_WARM -> {
                return new ItemStack(dirty_warm_WaterBottle);
            }
            case SALTY_WARM -> {
                return new ItemStack(salty_warm_WaterBottle);
            }
            case CLEAN_WARM -> {
                return new ItemStack(clean_warm_WaterBottle);
            }

            case RADIOACTIVE_HOT -> {
                return new ItemStack(radioactive_hot_WaterBottle);
            }
            case HOT -> {
                return new ItemStack(hot_WaterBottle);
            }
    ...
    public static ItemStack getBucketFromWaterType(WaterUtils.WATER_TYPES type) {
        switch (type) {
            case RADIOACTIVE_FROSTY -> {
                return new ItemStack(bucket_radioactive_frosty_Water);
            }
            case FROSTY -> {
                return new ItemStack(bucket_frosty_Water);
            }
            case RADIOACTIVE_COLD -> {
                return new ItemStack(bucket_radioactive_cold_Water);
            }
            case DIRTY_COLD -> {
                return new ItemStack(bucket_dirty_cold_Water);
            }
            case SALTY_COLD -> {
                return new ItemStack(bucket_salty_cold_Water);
            }
            case CLEAN_COLD -> {
                return new ItemStack(bucket_clean_cold_Water);
            }
            case RADIOACTIVE -> {
                return new ItemStack(bucket_radioactive_Water);
            }
            case DIRTY -> {
                return new ItemStack(bucket_dirty_Water);
            }
            case SALTY -> {
                return new ItemStack(bucket_salty_Water);
            }
            case RADIOACTIVE_WARM -> {
                return new ItemStack(bucket_radioactive_warm_Water);
            }
            case DIRTY_WARM -> {
                return new ItemStack(bucket_dirty_warm_Water);
            }
            case SALTY_WARM -> {
                return new ItemStack(bucket_salty_warm_Water);
            }
            case CLEAN_WARM -> {
                return new ItemStack(bucket_clean_warm_Water);
            }
            case RADIOACTIVE_HOT -> {
                return new ItemStack(bucket_radioactive_hot_Water);
            }
            case HOT -> {
                return new ItemStack(bucket_hot_Water);
            }
            default -> {
    ...
    public static void registerRecipes() {
        ...
        for (String oreDictName : new String[] { "ingotGold", "ingotBrass", "ingotAluminumBrass",
            "ingotAluminiumBrass" }) {
        ...
        GameRegistry.addRecipe(
            ...
            " r ",
            'w',
            new ItemStack(spoiledMilk, 1, 0),
            'r',
            new ItemStack(rottenFood, 1));
        GameRegistry.addRecipe(
        ...
        GameRegistry.addRecipe(
            ...
            'y',
            new ItemStack(airFilter),
            'z',
            new ItemStack(Blocks.glass_pane));
        GameRegistry.addRecipe(
            new ItemStack(hardHat, 1),
            "xyx",
            "xzx",
            'x',
        ...
        // GameRegistry.addRecipe(new ItemStack(davyLampBlock), " x ", "zyz", "xxx", 'x', new
        // ItemStack(Items.gold_ingot), 'y', new ItemStack(Blocks.torch), 'z', new ItemStack(Blocks.glass_pane));
        CraftingManager.getInstance()
            .getRecipeList()
            .add(
                new ShapedOreRecipe(
                    new ItemStack(davyLampBlock, 1),
                    " x ",
                    "zyz",
                    "xxx",
                    'x',
        ...
        camelStack2.getTagCompound()
            .setInteger(EM_Settings.CAMEL_PACK_FILL_TAG_KEY, 25);
        GameRegistry.addRecipe(
            camelStack2,
            "xxx",
            "xyx",
    ...
    public static String[] DefaultIgnitionSources() {
        String[] list = new String[] { "minecraft:flowing_lava", "minecraft:lava", "enviromine:fake_torch",
            ...
            "chisel:jackolantern9", "chisel:jackolantern10", "chisel:jackolantern11", "chisel:jackolantern12",
            "chisel:jackolantern13", "chisel:jackolantern14", "chisel:jackolantern15", "chisel:jackolantern16",
            "chisel:torch1", "chisel:torch2", "chisel:torch3", "chisel:torch4", "chisel:torch5", "chisel:torch6",
            "chisel:torch7", "chisel:torch8", "demonmobs:hellfire", "easycoloredlights:easycoloredlightsCLStone=-1",
            "etfuturum:magma", "fossil:skullLantern", "GardenCore:small_fire", "harvestcraft:pamcandleDeco1",
            "harvestcraft:pamcandleDeco2", "harvestcraft:pamcandleDeco3", "harvestcraft:pamcandleDeco4",
            "harvestcraft:pamcandleDeco5", "harvestcraft:pamcandleDeco6", "harvestcraft:pamcandleDeco7",
            "harvestcraft:pamcandleDeco8", "harvestcraft:pamcandleDeco9", "harvestcraft:pamcandleDeco10",
            "harvestcraft:pamcandleDeco11", "harvestcraft:pamcandleDeco12", "harvestcraft:pamcandleDeco13",
            "harvestcraft:pamcandleDeco14", "harvestcraft:pamcandleDeco15", "harvestcraft:pamcandleDeco16",
            "IguanaTweaksTConstruct:clayBucketLava", "IguanaTweaksTConstruct:clayBucketsTinkers:*",
            "infernomobs:bucketpurelava", "infernomobs:cinderfallsword", "infernomobs:cinderfallswordverdant",
            "infernomobs:cinderfallswordazure", "infernomobs:emberscepter", "infernomobs:magmacharge",
            "infernomobs:magmascepter", "infernomobs:purelava", "infernomobs:scorchfire",
            "infernomobs:scorchfirescepter", "infernomobs:scorchfirecharge", "infernomobs:soulstoneinferno",
            "netherlicious:FoxFire", "netherlicious:MagmaBlock", "netherlicious:SoulFire", "Railcraft:lantern.stone",
            "Railcraft:lantern.metal", "Railcraft:lantern.stone", "TConstruct:decoration.stonetorch",
            "ThermalFoundation:bucket:*", "ThermalFoundation:FluidGlowstone", "ThermalFoundation:FluidEnder",
            "ThermalFoundation:FluidPyrotheum", "ThermalFoundation:FluidMana", "torchLevers:torchLever",
            "torchLevers:torchButton", "uptodate:magma_block", };
    ...
    public static void LoadIgnitionSources(String[] listIn) {
        for (String source : listIn) {
            try {
                ...
                if (EM_Settings.loggerVerbosity >= EnumLogVerbosity.ALL.getLevel()) EnviroMine.logger.log(
                    Level.INFO,
                    "Registered " + sBlock.getLocalizedName() + "(" + source + ") as an ignition source.");
